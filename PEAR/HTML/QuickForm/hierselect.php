...
{   
    ...
    function _createElements()
    {
        ...
        for ($i = 0; $i < $this->_nbElements; $i++) {
            ...
            $this->_elements[] = new HTML_QuickForm_select($i, $label, array(), $this->getAttributes());
        }
...
//        $renderer->_groupElementTemplate = '<label>{label}</label>{element}';
    ...
    function accept(&$renderer, $required = false, $error = null)
    {
        ...
        //HTML_QuickForm_group::accept($renderer, $required, $error);
    } // end func accept
