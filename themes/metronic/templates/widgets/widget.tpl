...
{/if}
<div class="{$base_class} {if isset($T_DATA.panel)}panel-{if $T_DATA.panel|@is_string}{$T_DATA.panel}{else}default{/if}{/if} {if isset($T_DATA.box)}box {$T_DATA.box}{/if}" {if isset($T_DATA.id)}id="{$T_DATA.id}"{/if}>
