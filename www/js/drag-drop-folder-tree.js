...
//    this.deleteImage = 'error_delete.png';
    ...
    this.maximumDepth = 6;
    this.deletedUnits = new Array(); //SysClass custom variable
    this.activatedUnits = new Array(); //SysClass custom variable
    this.deactivatedUnits = new Array(); //SysClass custom variable
    ...
    */
    ...
    showHideNode : function(e, inputId) {
        if(inputId){
            ...
            if (!thisNode)
                return; //Added this line to avoid js error in copy content
        } else {
            thisNode = this;
            if (this.tagName=='A')
        ...
        if (this.deleteAllowed || this.renameAllowed) {
            try {
                ...
                if (this.deleteAllowed) {
                    menuModel.addItem(1,'Delete','','',false,'JSTreeObj.deleteUnit');
                }
