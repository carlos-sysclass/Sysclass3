            ...
            if (http_request.status == 200) {
                ...
                if (http_request.responseText == "ack") {
                    ...
                    if (response[0] == chatRoomDoesNotExistError) {
                        test.document.getElementById("chat_content").innerHTML = '<table class="chatbox" cellspacing="0" cellpadding="0"  style="width:'+table_style_size+'"><tr><td style="font-size:'+current_font_size+'px;color:red;" align="left">'+ translations['chatroomdeleted'] + '<BR>' + redicrectedToMagesterMain + '</td></tr></table>';
                        ...
                        test.document.getElementById("chat_content").innerHTML = '<table class="chatbox" cellspacing="0" cellpadding="0"  style="width:'+table_style_size+'"><tr><td style="font-size:'+current_font_size+'px;color:red;" align="left">' +chatRoomHasBeenDeactivated + '<BR>' + redicrectedToMagesterMain + '</td></tr></table>';
...
function toggleDirections(imageObj) {
    //changed in 20/6/2007 by makriria because of http://www.dreamincode.net/code/snippet293.htm   getElementsByName has problems in IE
    /*
