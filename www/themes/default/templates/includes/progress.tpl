{*moduleProgress: The Progress page*}
 ...
 {if $smarty.get.edit_user || $_student_}
    ...
    {/if}
     ...
     {/capture}
     {sC_template_printBlock title = "`$smarty.const._PROGRESSFORUSER`: <span class = 'innerTableName'>&quot;#filter:login-`$T_USER_LESSONS_INFO.users_LOGIN`#&quot;</span>" data = $smarty.capture.t_edit_progress_code image = '32x32/users.png' help = 'Users_status'}
 {else}
...
{/if}
         {/capture}
         {sC_template_printBlock title = $smarty.const._USERSPROGRESS data = $smarty.capture.t_progress_code image = '32x32/users.png' help = 'Users_status'}
 {/if}
 </td></tr>
 {/capture}
