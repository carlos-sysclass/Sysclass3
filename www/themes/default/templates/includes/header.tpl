...
<body {if isset($T_CURRENT_CTG)}id = "body_{$T_CURRENT_CTG}"{elseif $smarty.server.PHP_SELF|basename == 'index.php'}id = "index_page"{/if} onkeypress = "if (window.sC_js_keypress) sC_js_keypress(event);" onbeforeunload = "if (window.getPeriodicData) getPeriodicData();">
{/if}
