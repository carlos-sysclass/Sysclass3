    ...
    {capture name = "moduleContentMetadata"}
        <tr><td class = "moduleCell">
	        ...
	        {/capture}
	        {sC_template_printBlock title = $smarty.const._METADATAFORUNIT|cat:' &quot;'|cat:$T_CURRENT_UNIT.name|cat:'&quot;' data = $smarty.capture.t_content_info_code image = '32x32/information.png'}
		</td></tr>
	{/capture}
