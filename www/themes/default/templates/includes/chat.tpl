...
{else}
 ...
 <tr><td class = "moduleCell">
   ...
   <div class = "headerTools">
    ...
    <span>
    {if $T_CHAT_ENABLED}
     <img src = "images/16x16/chat.png" alt = "{$smarty.const._DEACTIVATEMAGESTERCHAT}" title = "{$smarty.const._DEACTIVATEMAGESTERCHAT}"/>
           <a href = "{$smarty.server.PHP_SELF}?ctg=chat&activate_system_chat=0">{$smarty.const._DEACTIVATEMAGESTERCHAT}</a>
             {else}
     <img src = "images/16x16/chat.png" class = "inactiveImage" alt = "{$smarty.const._ACTIVATEMAGESTERCHAT}" title = "{$smarty.const._ACTIVATEMAGESTERCHAT}"/>
              <a href = "{$smarty.server.PHP_SELF}?ctg=chat&activate_system_chat=1">{$smarty.const._ACTIVATEMAGESTERCHAT}</a>
