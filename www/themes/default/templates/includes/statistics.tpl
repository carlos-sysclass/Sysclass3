{if !isset($T_OPTION)}
        <table class = "statisticsPanel">
            <tr><td>
                    ...
                    {sC_template_printBlock title = $smarty.const._STATISTICS columns = 4 links = $T_STATISTICS_OPTIONS image = '32x32/options.png' help = 'Reports' groups = $T_REPORTS_GROUPS}
