...
<!--/ajax:scormUsersTable-->
                            {/capture}
                            {sC_template_printBlock title = $smarty.const._REVIEWSCORMDATAFOR|cat:' &quot;'|cat:$T_CURRENT_LESSON->lesson.name|cat:'&quot;' data = $smarty.capture.scorm_review_code image = '32x32/scorm.png' main_options = $T_TABLE_OPTIONS help = 'SCORM_/_IMS'}
         ...
         {/foreach}
                            ...
                            {/capture}
                            {sC_template_printBlock title = $smarty.const._SCORMIMPORT data = $smarty.capture.scorm_import_code image = '32x32/scorm.png' main_options = $T_TABLE_OPTIONS help = 'SCORM_/_IMS'}
                        ...
                        {elseif $smarty.get.scorm_export}
                            ...
                            {/capture}
                            {sC_template_printBlock title = $smarty.const._SCORMEXPORT data = $smarty.capture.scorm_export_code image = '32x32/scorm.png' main_options = $T_TABLE_OPTIONS help = 'SCORM_/_IMS'}
                        ...
                        {else}
                            ...
                            {/capture}
                            {sC_template_printBlock title = $smarty.const._SCORMOPTIONSFOR|cat:' &quot;'|cat:$T_CURRENT_LESSON->lesson.name|cat:'&quot;' data = $smarty.capture.t_scorm_tree_code image = '32x32/scorm.png' main_options = $T_TABLE_OPTIONS help = 'SCORM_/_IMS'}
                        {/if}
                                </td></tr>
        {/capture}
