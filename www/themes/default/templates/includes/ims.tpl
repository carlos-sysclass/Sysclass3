       ...
       <tr><td class = "moduleCell">
         ...
         {/foreach}
                            ...
                            {sC_template_printBlock title = $smarty.const._IMSIMPORT data = $smarty.capture.ims_import_code image = '32x32/autocomplete.png' main_options = $T_TABLE_OPTIONS help = 'SCORM_/_IMS'}
                        ...
                        {elseif $smarty.get.ims_export}
                            ...
                            {/capture}
                            {sC_template_printBlock title = $smarty.const._IMSEXPORT data = $smarty.capture.ims_export_code image = '32x32/autocomplete.png' main_options = $T_TABLE_OPTIONS help = 'SCORM_/_IMS'}
                        {/if}
                                </td></tr>
        {/capture}
