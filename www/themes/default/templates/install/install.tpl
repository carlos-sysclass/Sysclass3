...
*}
 ...
 {elseif $smarty.get.finish}
  ...
  <div style = "text-align:center;font-size:14px;">
   ...
   <p>SysClass installed succesfully!</p>
 ...
 {else}
  ...
  <div style = "text-align:center;font-size:14px;">
   <p>Welcome to SysClass's installation wizard! Click on a button below to start.</p>
...
{capture name = "header_code"}
  <div id = "logo">
   <a href = "index.php"><img src = "images/logo.png" title = "SysClass" alt = "SysClass" border = "0"></a>
  </div>
  <div id = "info">
   <div id = "site_name">SysClass</div>
...
{capture name = "footer_code"}
  <a href = "www.magester.net">SysClass</a> version {$smarty.const.G_VERSION_NUM} build {$smarty.const.G_BUILD} &bull; {$T_VERSION_TYPE} Edition
{/capture}
