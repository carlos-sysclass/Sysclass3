...
{else}
 {capture name = 't_lesson_info_code'}
     ...
     <table>
         ...
         <tr>
         	<td>
         		<img style="vertical-align:middle;" src="images/16x16/user.png" alt="{$smarty.const._PROFESSORS}" title="{$smarty.const._PROFESSORS}"/>
         		<span style="vertical-align:middle;">&nbsp;{$smarty.const._PROFESSORS}:&nbsp;</span>
         	</td>
             <td>
