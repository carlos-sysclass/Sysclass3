  ...
  {/if}
        ...
        {$T_ADD_MESSAGE_FORM.hidden}
	        {if $T_DESTINATARYALREADYSELECTED}
				{sC_template_printBlock title = $smarty.const._RECIPIENTSSELECTION data = $smarty.capture.t_recipients_code image = '32x32/directory.png' help = 'Messages' style= 'display: none;'}
				{sC_template_printBlock title = $smarty.const._DESTINATARYSELECTIONTITLE data = $T_DESTINATARYSELECTION image = '32x32/directory.png' help = 'Messages'}
         ...
         {if $T_DESTINATARYALREADYSELECTED}
	        ...
	        {literal}
		        $j(document).ready(function () {
		        	 sC_js_selectRecipients(specific_recipient);
				});
			{/literal}
	         </script>
         {/if}
