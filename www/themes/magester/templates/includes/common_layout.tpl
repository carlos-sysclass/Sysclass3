{if !$smarty.get.popup && !$T_POPUP_MODE}
 <table class = "pageLayout {if $smarty.server.PHP_SELF|basename == 'index.php'}index{/if} {if isset($T_MAXIMIZE_VIEWPORT)}centerFull hideBoth{else}{$layoutClass}{/if}" id = "pageLayout">
