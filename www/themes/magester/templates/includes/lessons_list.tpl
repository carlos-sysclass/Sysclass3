   ...
   <div id = 'group_key_enter' style = "display:none;">
    ...
    {/if}
      ...
      {if $T_CURRENT_USER->coreAccess.dashboard != 'hidden'}
                 <td class = "lessonListOption"><a href = "{$smarty.server.PHP_SELF}?ctg=personal" title="{$smarty.const._MYACCOUNT}"><img class = "handle" src = "images/32x32/user_mapping.png" title = "{$smarty.const._MYACCOUNT}" alt = "{$smarty.const._MYACCOUNT}"></a></td>
   ...
   {else}
    {capture name = "t_empty_lessons_list_code"}
     ...
     {if $T_CURRENT_USER->coreAccess.dashboard != 'hidden'}
        ...
        <a href = "{$smarty.server.PHP_SELF}?ctg=personal" title="{$smarty.const._MYACCOUNT}"><img class = "handle" src = "images/32x32/user_mapping.png" title = "{$smarty.const._MYACCOUNT}" alt = "{$smarty.const._MYACCOUNT}" ></a>
