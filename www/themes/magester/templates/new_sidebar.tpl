...
<!-- 
    <div id="loading_sidebar" class="loading" style="opacity: 0.9; height: 100%; width: 229px; display: block;" >
    <div style="top: 50%; left:12%; position: absolute;" >
    <img src="images/others/progress1.gif" style="vertical-align: middle;"/>
    <span style="vertical-align: middle;">{$smarty.const._LOADINGDATA}</span>
    </div></div>
    -->
