...
function smarty_function_eF_template_printBlock($params, &$smarty) {
    ...
    if (isset($params['options'])) {
        ...
        foreach ($params['options'] as $key => $value) {
            ...
            !isset($params['absoluteImagePath']) && $value['image'] ? $value['image'] = 'images/' . $value['image'] : null;
            //if absoluteImagePath is specified, it means that $params['image'] contains an absolute path (or anyway it refers to an image not under www/images/)
