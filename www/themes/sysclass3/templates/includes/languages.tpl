...
<!--
                                    <img src = "images/16x16/edit_inline.png" title = "{$smarty.const._INLINE_EDIT}" alt = "{$smarty.const._INLINE_EDIT}" onclick = "_sysclass('load', 'language').loadInlineEditor('{$language.name}', '#inlineEditor');"/>
-->
...
<!--/ajax:languagesTable-->
                        <br />
                        <div id="inlineEditor" title="{$smarty.const.__LANGUAGE_EDIT_LANGUAGE}">
                            <input name="editor_selected_language" type="hidden" value="" />
                            <textarea id="inline-code"></textarea>
                        </div>
                        <br />
