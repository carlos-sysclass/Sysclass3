...
<html{if $smarty.server.PHP_SELF|basename == 'browse.php' || $smarty.server.PHP_SELF|basename == 'browsecontent.php'}class = "whitebg"{/if} {if $smarty.get.popup || $T_POPUP_MODE}class = "popup"{/if} {if $T_RTL}dir = "rtl"{/if} {if $T_OPEN_FACEBOOK_SESSION}xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml"{/if}>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="http://sysclass.com/min/b=themes/sysclass3/css&f=fixed/24columns.css,reset.css,screen.css,jquery.wysiwyg.css,jquery.ui.css,menu.css,forms.css,old.css,lists.css,revision.css,icons.css" />
		<!-- New Admin -->
		<!-- IE HTML5 -->
		<!--[if lt IE 9]>
			<script src="//html5shiv.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<link type="text/css" rel="stylesheet" href="http://sysclass.com/min/b=css&f=reset_admin.css,sprite_admin.css,style_admin.css" />
		<!-- /end new admin -->
		{if isset($T_MODULE_CSS_STRING)}
			<link type="text/css" rel="stylesheet" href="http://sysclass.com/min/f={$T_MODULE_CSS_STRING}" />
		{/if}
