...
{if isset($T_MODULE_JS_STRING)}
	<script type = "text/javascript" src="http://sysclass.com/min/f={$T_MODULE_JS_STRING}"></script> {*///MODULES LINK JAVASCRIPT CODE*}
{/if}
<script type = "text/javascript" src="http://sysclass.com/min/f=themes/{$T_THEME_SETTINGS->themes.path}js/sysclass.js,js/script_jquery.js"></script> {*///MODULES LINK JAVASCRIPT CODE*}
