...
{elseif $T_OP == 'course_classes'}
  ...
  {/capture}
  {sC_template_printBlock title = $smarty.const.__COURSE_CLASSE data = $smarty.capture.t_course_classe_code image = '32x32/import.png' main_options = $T_TABLE_OPTIONS options = $T_COURSE_OPTIONS }
