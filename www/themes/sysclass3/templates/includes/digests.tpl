       ...
       {/if}
        ...
        {capture name = 't_queue_messages_code'}
			...
			<!--	<img src="images/16x16/go_into.png" title="{$smarty.const._SENDNEXTQUEUEMESSAGES}" alt="{$smarty.const._SENDNEXTQUEUEMESSAGES}"> -->
     			<img class=" sprite16 sprite16-go_into" src="themes/default/images/others/transparent.gif" title="{$smarty.const._SENDNEXTQUEUEMESSAGES}" alt="{$smarty.const._SENDNEXTQUEUEMESSAGES}">
