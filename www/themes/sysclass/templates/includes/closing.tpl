...
<script type = "text/javascript" src = "modules/module_language/js/language.js.php"> </script> {*///MODULES LANGUAGE JAVASCRIPT... MUST BE LOADED FIRST *}
...
<div id = "error_details" style = "display:none">{sC_template_printBlock title=$smarty.const._ERRORDETAILS data="<pre>`$T_EXCEPTION_TRACE`</pre>" image='32x32/error_delete.png'}</div>
...
if (!usingHorizontalInterface) {
 ...
 if (jQuery('#current_location').size()) {
	jQuery('#current_location').get(0).value = document.location.toString();
 }
}
{/literal}
...
<!-- 
		<script src="/themes/sysclass/js/plugins.js"></script>
		
		<script type="text/javascript" src="/themes/sysclass/js/fancybox/jquery.fancybox-1.3.4.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/quicksand/jquery.quicksand.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/quicksand/custom_sorter.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/quicksand/dash_sorter.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/quicksand/jquery-css-transform.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/quicksand/jquery-animate-css-rotate-scale.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/tinyeditor/tinyeditor.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/DataTables/jquery.dataTables.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/jqueryFileTree/jqueryFileTree.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/slidernav/slidernav.js"></script>
		<script type="text/javascript" src="/themes/sysclass/js/fullcalendar/fullcalendar.min.js"></script>
		<script type='text/javascript' src='/themes/sysclass/js/fullcalendar/gcal.js'></script> 
		<script type='text/javascript' src='/themes/sysclass/js/flot/excanvas.js'></script>
		<script type='text/javascript' src='/themes/sysclass/js/flot/jquery.flot.js'></script>
		<script type='text/javascript' src='/themes/sysclass/js/flot/jquery.flot.resize.js'></script>
		<script type='text/javascript' src='/themes/sysclass/js/flot/jquery.flot.pie.js'></script>
 -->
		<!-- This file configures the various jQuery plugins for Adminica. Contains links to help pages for each plugin. -->
<!-- 		<script type="text/javascript" src="/themes/sysclass/js/adminica/adminica_ui.js"></script> -->
