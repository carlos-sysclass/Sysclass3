...
///$loadScripts = array('scriptaculous/prototype', 'MagesterScripts', 'drag-drop-folder-tree');
$loadScripts = array(/* 'scriptaculous/prototype', 'MagesterScripts', */ 'drag-drop-folder-tree');

$contentTree = new MagesterContentTree($_SESSION['s_lessons_ID']);
$visitableIterator = new MagesterVisitableFilterIterator(new MagesterNodeFilterIterator(new RecursiveIteratorIterator(new RecursiveArrayIterator($contentTree -> tree), RecursiveIteratorIterator :: SELF_FIRST)));
