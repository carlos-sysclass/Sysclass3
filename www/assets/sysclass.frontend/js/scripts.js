...
//Navigation Scrolling
	$(function() {
	$('.nav a, .nav li a, #home-center a, a.move').bind('click',
	function(event){
		var $anchor = $(this);
		$('html, body').stop().animate({
...
function () {
	...
	$('#twitter-parallax').parallax("30%",
	0.1);
		$('#quote-parallax').parallax("30%",
	0.1);
		$('#contact-parallax').parallax("30%",
	0.1);
		$('#home.parallax').parallax("30%",
	0.1);
		$('#project-header.parallax').parallax("30%",
	0.1);
		/*add as necessary*/
}//BxSlider
$(document).ready(function(){
	...
	$('.bx-wrapper .bx-controls-direction a').attr('data-500',
	'top:83%; opacity: 0;').attr('data-start',
	'top:50%; opacity: 1;');
...
//Google Map					
	var latlng = new google.maps.LatLng(32.780311,
	-96.800501);
	var settings = {
		zoom: 14,
		center: new google.maps.LatLng(32.780311,
		-96.800501),
	...
	var contentString = '<div id="content">'+
		'<div id="siteNotice">'+
		'</div>'+
		'<h3 id="firstHeading" class="firstHeading">SYSCLASS</h3>'+
		'<div id="bodyContent">'+
	...
	var companyImage = new google.maps.MarkerImage('assets/sysclass.frontend/images/marker.png',
	new google.maps.Size(58,
	63),
	<!-- Width and height of the marker -->
		new google.maps.Point(0,
	0),
	new google.maps.Point(35,
	20)<!-- Position of the marker -->
	);
	var companyPos = new google.maps.LatLng(32.780311,
	-96.800501);
...
$(function (){
	$('#fullscreen-slider').maximage({
		...
		onFirstImageLoaded: function(){
			...
			jQuery('.slide-content a').bind('click',
			function(event){
				var $anchor = $(this);				
	...
	(function(){
		var container = $( "#project-page-holder" );
		  ...
		  $('#project-page-data').animate({
				...
				400,
				function(){
					$("#project-page-data").load(myUrl,
					function(e){
						var $helper = $('.helper');
					var height = $helper.height();
						$('#project-page-data').css("min-height",
						height);
						$('.project-slider').css({
							'height' : ''
						});	
		  ...
		  $('html, body').animate({
				...
				900);
		  //Project Page Open
			  $('#project-page-holder').slideUp(600,
				function(){
					$('#project-page-data').css('visibility',
					'visible');
				}).delay(1100).slideDown(1000,
				function(){
					$('#project-page-data').fadeIn('slow',
					function(){
						initBxModal();
					});
						$('.element_fade_in').each(function () {
