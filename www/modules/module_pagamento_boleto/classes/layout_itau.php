	...
	<TBODY>
		<TR>
			<TD class=ct width=666><img height=1
				src=<?php echo $this->moduleBaseLink . "images/6.png"; ?> width=665
				border=0></TD>
		</TR>
		<TR>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
	<tr>
		<td width="113"><IMG
			SRC="<?php echo $this->moduleBaseLink . "images/logo_empresa.png"; ?>"></td>
		<td class=ti width=455><?php echo $dadosboleto["identificacao"]; ?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? "<br>".$dadosboleto["cpf_cnpj"] : '' ?><br>
		<?php echo $dadosboleto["logradouro"] . ', ' . $dadosboleto["numero"] . ' ' . $dadosboleto["complemento"] . ' - ' . $dadosboleto["bairro"]; ?><br>
		<?php echo $dadosboleto["cidade"] . ' / ' . $dadosboleto["uf"] ; ?><br>
		</td>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
 ...
 --></td>
		<td width=3 valign=bottom><img height=22
			src=<?php echo $this->moduleBaseLink . "images/3.png"; ?> width=2
			border=0></td>
		...
		<td class=ld align=right width=453 valign=bottom><span class=ld> <span
			class="campotitulo"> <?php echo $dadosboleto["linha_digitavel"]?> </span></span></td>
	</tr>
	<tbody>
		<tr>
			<td colspan=5><img height=2
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=666
				border=0></td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		<tr>
			<td class=ct valign=top width=7 height=13><img height=13
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
		...
		<tr>
			...
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
			<td class=cp valign=top width=156 height=12><span class="campo"> <?php echo $dadosboleto["agencia_codigo"]?>
			</span></td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
		...
		<tr>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=268 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=268
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=156 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=156
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=34 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=34
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=53 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=53
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=120 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=120
				border=0></td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		...
		<tr>
			...
			<td valign=top width=113 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=113
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=72 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=72
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=132 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=132
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=134 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=134
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=180 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=180
				border=0></td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		<tr>
			<td class=ct valign=top width=1 height=13><img height=13
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
			<td class=ct valign=top width=119 height=13 style="white-space: nowrap;">(-) Desconto/Abatimentos</td>
			<td class=ct valign=top width=7 height=13><img height=13
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
		...
		<tr>
			<td valign=top width=1 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=1
				border=0></td>
			<td valign=top width=119 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=119
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=112 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=112
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
	...
	<tbody>
		...
		<tr>
			...
			<td valign=top width=659 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=659
				border=0></td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		...
		<tr>
			...
			<td class=cp valign=top width=7 height=12><img height=12
				...
				border=0></td>
			<td class=cp valign=top align=right width=180 height=12><span
				class="campo"> <?php echo $dadosboleto["data_vencimento"]?> </span></td>
		</tr>
		<tr>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
			...
			<td valign=top width=472 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=472
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
	...
	<tbody>
		...
		<tr>
			...
			<td class=cp valign=top width=7 height=12><img height=12
				...
				border=0></td>
			<td class=cp valign=top align=right width=180 height=12><span
				class="campo"> <?php echo $dadosboleto["agencia_codigo"]?> </span></td>
		</tr>
		<tr>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
...
<table cellspacing=0 cellpadding=0 border=0>
	<tbody>
		...
		<tr>
			...
			<div align=left><span class="campo"> <?php echo $dadosboleto["data_documento"]?>
			</span></div>
			</td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
			<td class=cp valign=top width=133 height=12><span class="campo"> <?php echo $dadosboleto["numero_documento"]?>
			</span></td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
			<td class=cp valign=top width=62 height=12>
			<div align=left><span class="campo"> <?php echo $dadosboleto["especie_doc"]?>
			</span></div>
			</td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
			...
			<div align=left><span class="campo"> <?php echo $dadosboleto["aceite"]?>
			</span></div>
			</td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
			...
			<div align=left><span class="campo"> <?php echo $dadosboleto["data_processamento"]?>
			</span></div>
			</td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
		...
		<tr>
			...
			<td valign=top width=133 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=133
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=62 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=62
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			...
			<td valign=top width=102 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=102
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	<tbody>
		...
		<tr>
			...
			<div align=left><span class="campo"> <?php echo $dadosboleto["carteira"]?>
			</span></div>
			</td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
			...
			<div align=left><span class="campo"> <?php echo $dadosboleto["especie"]?>
			</span></div>
			</td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
			<td class=cp valign=top width=103><span class="campo"> <?php echo $dadosboleto["quantidade"]?>
			</span></td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
			<td class=cp valign=top width=92><span class="campo"> <?php echo $dadosboleto["valor_unitario"]?>
			</span></td>
			<td class=cp valign=top width=7 height=12><img height=12
				src=<?php echo $this->moduleBaseLink . "images/1.png"; ?> width=1
				border=0></td>
		...
		<tr>
			<td valign=top width=7 height=1><img height=1
				...
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=75
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=31 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=31
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=83 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=83
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			...
			<td valign=top width=103 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=103
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
			<td valign=top width=92 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=92
				border=0></td>
			<td valign=top width=7 height=1><img height=1
				src=<?php echo $this->moduleBaseLink . "images/2.png"; ?> width=7
				border=0></td>
				...
				<tbody>
					...
					<tr>
						<td valign=top width=7 height=1><img height=1
							...
							border=0></td>
						<td valign=top width=180 height=1><img height=1
							src=<?php echo $this->moduleBaseLink . "images/2.png"; ?>
...
<TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
	<TBODY>
		<TR>
			<TD vAlign=bottom align=left height=50><?php fbarcode($dadosboleto["codigo_barras"], $this); ?>
			</TD>
		</tr>
	</tbody>
</table>
