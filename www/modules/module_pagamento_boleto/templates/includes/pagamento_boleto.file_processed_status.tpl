{if $T_PROCESS_FILE}
	...
	{capture name="preview_registers"}
		{assign var=t_status value=$T_PROCESS_FILE_STATUS.registros}
				<table class="display" id="_PAGAMENTO_BOLETO_FILE_RETURN_LIST">
					<thead> 
						<tr>
								...
								<td align="center">
									<div class="button_display">
										{if $item.tag}
											...
											{/if}
											<!-- 
											<button onclick="javascript: void(0);" class="skin_colour round_all">
	...
	{capture name="preview_footer"}
		{assign var=t_status value=$T_PROCESS_FILE_STATUS.footer}
			...
			{*$t_status.valor_total.formatteddata*}
	{/capture}

		
	
	{if !$smarty.get.ajax}
		{capture name="preview_html"}
			<!-- 
			...
			<div class="clear"></div>
			-->
			<div class="box border grid_16" id="_PAGAMENTO_BOLETO_FILE_HEADER">
				{$smarty.capture.preview_header}
			</div>
			<div class="clear"></div>
			<div class="box no_padding no_padding_color grid_16" id="_PAGAMENTO_BOLETO_FILE_REGISTERS">
				{$smarty.capture.preview_registers}
			</div>
			<div class="clear"></div>
			
			<div class="box border grid_16" id="_PAGAMENTO_BOLETO_FILE_FOOTER">
