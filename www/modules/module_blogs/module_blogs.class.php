<?php
class module_blogs extends MagesterModule {
...
//pr($blogPosts);
    ...
    public function getDashboardSmartyTpl() {
    	return $this->getLessonSmartyTpl();
    }
    */
    ...
    public function getSidebarLinkInfo() {
        ...
        $link_of_menu_system = array (array ('id' => 'blogs_link_id1',
                                              	'title' => _BLOGS_BLOG,
                                              	'image' => $this -> moduleBaseDir.'images/_magesterBlog16',
	...
	public function getLessonCenterLinkInfo() {
        ...
        if ($currentUser -> getRole($this -> getCurrentLesson()) == "professor") {
            return array('title' => _BLOGS_BLOG,
                         'image' => $this -> moduleBaseDir.'images/_magesterBlog32.png',
                         'link'  => $this -> moduleBaseUrl);
        }
    }
