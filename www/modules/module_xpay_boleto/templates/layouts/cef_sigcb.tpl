			...
			<TD valign=top class=cp><DIV ALIGN="left">
					...
					<li>Caso tenha problemas ao imprimir, copie a seqüencia numérica
						...
						<span class="ld2"> &nbsp;&nbsp;&nbsp;&nbsp;Linha Digitável:
							&nbsp;{$T_XPAY_BOLETO_CFG.linha_digitavel}<br>
							&nbsp;&nbsp;&nbsp;&nbsp;Valor: &nbsp;&nbsp;R$
							{$T_XPAY_BOLETO_CFG.valor_boleto}<br>
					</span>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tr>
			<td class=cp width=150><span class="campo"><IMG
					src="{$T_XPAY_BOLETO_BASELINK}images/layouts/logocaixa.jpg"
					width="150" height="40" border=0> </span></td>
			<td width=3 valign=bottom><img height=22
				src={$T_XPAY_BOLETO_BASELINK}images/layouts/3.png width=2 border=0>
			</td>
			<td class=cpt width=58 valign=bottom><div align=center>
					<font class=bc>{$T_XPAY_BOLETO_CFG.codigo_banco_com_dv}</font>
				</div></td>
			<td width=3 valign=bottom><img height=22
				src={$T_XPAY_BOLETO_BASELINK}images/layouts/3.png width=2 border=0>
			</td>
			<td class=ld align=right width=453 valign=bottom><span class=ld> <span
					class="campotitulo"> {$T_XPAY_BOLETO_CFG.linha_digitavel} </span>
			</span></td>
		</tr>
		<tbody>
			<tr>
		...
		<tbody>
			<tr>
				<td class=ct valign=top width=7 height=13><img height=13
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
			...
			<tr>
				...
				<td class=cp valign=top width=268 height=12><span class="campo">{$T_XPAY_BOLETO_CFG.cedente}</span>
				</td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=156 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.agencia_codigo} </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=34 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.especie} </span>
				</td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=53 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.quantidade} </span>
				</td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top align=right width=120 height=12><span
					class="campo"> {$T_XPAY_BOLETO_CFG.nosso_numero} </span></td>
			</tr>
			<tr>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
				...
				<td valign=top width=34 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=34 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
				<td valign=top width=53 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=53 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
		...
		<tbody>
			...
			<tr>
				...
				<td class=cp valign=top colspan=3 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.numero_documento} </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=132 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.cpf_cnpj} </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=134 height=12><span class="campo"> {if
						$T_XPAY_BOLETO_CFG.data_vencimento}
						{$T_XPAY_BOLETO_CFG.data_vencimento} {else} Contra Apresentação
						{/if} </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top align=right width=180 height=12><span
					class="campo"> {$T_XPAY_BOLETO_CFG.valor_boleto} </span></td>
			</tr>
			<tr>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				...
				<td valign=top width=72 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=72 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tbody>
			...
			<tr>
				...
				<td valign=top width=113 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=121
					border=0></td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
				...
				<td valign=top width=180 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=172
					border=0></td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			...
			<tr>
				...
				<td class=cp valign=top width=659 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.sacado} </span></td>
			</tr>
			<tr>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
		...
		<tbody>
			...
			<tr>
				...
				<td class=cp width=564><span class="campo">
						{$T_XPAY_BOLETO_CFG.demonstrativo1}<br>
						{$T_XPAY_BOLETO_CFG.demonstrativo2}<br>
						{$T_XPAY_BOLETO_CFG.demonstrativo3}<br>
				</span>
				</td>
				<td width=7></td>
				<td width=88></td>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tbody>
			...
			<tr>
				...
				<td class=cp valign=top align=right width=180 height=12><span
					class="campo"> {if $T_XPAY_BOLETO_CFG.data_vencimento}
						{$T_XPAY_BOLETO_CFG.data_vencimento} {else} Contra Apresentação
						{/if} </span></td>
			</tr>
			<tr>
		...
		<tbody>
			...
			<tr>
				...
				<td class=cp valign=top width=472 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.cedente} </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top align=right width=180 height=12><span
					class="campo"> {$T_XPAY_BOLETO_CFG.agencia_codigo} </span></td>
			</tr>
			<tr>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
		...
		<tbody>
			...
			<tr>
				...
				<td class=cp valign=top width=113 height=12><div align=left>
						<span class="campo"> {$T_XPAY_BOLETO_CFG.data_documento} </span>
					</div></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				...
				<td class=cp valign=top width=62 height=12><div align=left>
						<span class="campo"> {$T_XPAY_BOLETO_CFG.especie_doc} </span>
					</div></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=34 height=12><div align=left>
						<span class="campo"> {$T_XPAY_BOLETO_CFG.aceite} </span>
					</div></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top width=102 height=12><div align=left>
						<span class="campo"> {$T_XPAY_BOLETO_CFG.data_processamento} </span>
					</div></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
			...
			<tr>
				...
				<td valign=top width=62 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=62 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
		...
		<tbody>
			...
			<tr>
				...
				<td class=cp valign=top width=83>
					<div align=left>
						<span class="campo"> {$T_XPAY_BOLETO_CFG.carteira} </span>
					</div>
				</td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				...
				<td class=cp valign=top width=43><div align=left>
						<span class="campo"> {$T_XPAY_BOLETO_CFG.especie} </span>
					</div></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				...
				<td class=cp valign=top width=102><span class="campo">
						{$T_XPAY_BOLETO_CFG.valor_unitario} </span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
				<td class=cp valign=top align=right width=180 height=12><span
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=75 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
				<td valign=top width=31 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=31 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
				<td valign=top width=83 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=83 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
				<td valign=top width=43 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=43 border=0>
				</td>
				<td valign=top width=7 height=1><img height=1
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/2.png width=7 border=0>
				</td>
		...
		<tbody>
			<tr>
				...
				<td valign=top width=468 rowspan=5><font class=ct>Instruções (Texto
						...
						class=campo> {$T_XPAY_BOLETO_CFG.instrucoes1}<br>
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tbody>
			<tr>
				...
				<td class=cp valign=top width=659 height=12><span class="campo">
						{$T_XPAY_BOLETO_CFG.endereco1} </span>
				</td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr>
				...
				<td class=cp valign=top width=472 height=13><span class="campo">
						{$T_XPAY_BOLETO_CFG.endereco2} </span></td>
				<td class=ct valign=top width=7 height=13><img height=13
					src={$T_XPAY_BOLETO_BASELINK}images/layouts/1.png width=1 border=0>
				</td>
