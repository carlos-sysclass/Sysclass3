...
{sC_template_printBlock title=$smarty.const._TRANSLATE_TRANSLATE data=$smarty.capture.t_module_translate_code image=$T_MODULE_BASELINK|cat:'images/planet32.png' absoluteImagePath=1}
