ALTER TABLE `mod_translate_tokens` CHANGE COLUMN `token` `token` VARCHAR(970) CHARACTER SET 'latin1' COLLATE 'latin1_bin' NOT NULL ;
ALTER TABLE `mod_translate_tokens` CHANGE COLUMN `language_code` `language_code` VARCHAR(10) NOT NULL ;

ALTER TABLE `mod_lessons`
