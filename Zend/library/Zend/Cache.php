...
abstract class Zend_Cache
{
     ...
     * @deprecated
     */
    public static $availabl_magesterends = array('Core', 'Output', 'Class', 'File', 'Function', 'Page');
    ...
    public static function factory($frontend, $backend, $frontendOptions = array(), $backendOptions = array(), $customFrontendNaming = false, $customBackendNaming = false, $autoload = false)
    {
        ...
        if (is_string($frontend)) {
            $frontendObject = self::_mak_magesterend($frontend, $frontendOptions, $customFrontendNaming, $autoload);
        } else {
     ...
     * @return Zend_Cache_Core|Zend_Cache_Frontend
     */
    public static function _mak_magesterend($frontend, $frontendOptions = array(), $customFrontendNaming = false, $autoload = false)
    {
