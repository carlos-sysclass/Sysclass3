...
class MagesterProject {
     ...
     * $project      = new MagesterProject(32);               //Initialize project with id 32
     ...
     * $project = new MagesterProject(43);                //Instantiate project with id 43
   ...
   $result = eF_updateTableData("users_to_projects", array('grade' => $grade), "users_LOGIN='$login' and projects_ID=".$this -> project['id']);
        ...
        if ($result) {
            ...
            throw new MagesterContentException(_THEPROJECTGRADECOULDNOTBEUPDATED, MagesterContentException :: DATABASE_ERROR);
        }
    }
    /**
     ...
     * @return MagesterProject The new project
     ...
     * $project = new MagesterProject(12);                //Instantiate project with id 12
