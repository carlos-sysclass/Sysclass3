 ...
 * @package SysClass
 */
class MagesterPdfException extends Exception
{
}
...
class MagesterPdf
{
 ...
 /**
	 ...
	 * @param mixed $imageFile An MagesterFile or path to an image file, or false to use none
	 * @since 3.6.7
	 * @access public
	 */
  ...
  try {
   if ($imageFile) {
    if (!($imageFile instanceOf MagesterFile)) {
     $imageFile = new MagesterFile($imageFile);
    }
