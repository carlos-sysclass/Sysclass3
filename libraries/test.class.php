...
//pr($questions);
   ...
   $returnObjects ? $nonQuestions[$value['id']] = QuestionFactory :: factory($value) : $nonQuestions[$value['id']] = $value;
     ...
     * @return MagesterUnit The unit of this test
     ...
     * @return mixed Either an array with an $id => $name pair, or an MagesterLesson object
...
*/
     ...
     * @return MagesterTest the new test object
 ...
 /**
   ...
   //Count the total questions each unit has
     ...
     * @param mixed $user The user login to get information for, or an MagesterUser object
     ...
     * @param mixed $user The user to reset test for, either a user login or an MagesterUser instance
 ...
 public function redoOnlyWrong($user)
 {
  ...
  $testObject -> redoOnlyWrong = true;
     ...
     * @param mixed $user The user to delete test for, either a user login or an MagesterUser instance
   ...
   foreach ($result as $value) {
     ...
     * a new MagesterTest instance and stores it in the database.
     ...
     * @return MagesterCompletedTest a new MagesterCompletedTest instance, which represents the test (to be) completed
...
abstract class Question
{
 ...
 public $settings = array('force_correct' => 0,
  ...
  @unserialize($this -> question['settings'])!== false ? $this -> settings = unserialize($this -> question['settings']): $this -> settings = $this -> question['settings'];
     ...
     * @param mixed $uploadDirectory The directory to upload the file to, a string or an MagesterDirectory object
