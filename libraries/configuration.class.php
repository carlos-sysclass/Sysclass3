<?php
/**
 * MagesterConfiguration Class file
 *
 * @package SysClass
 */
...
class MagesterConfiguration
{
    ...
    private static $defaultOptions = array(
        ...
        //UTF7-IMAP for Windows servers who want to support international file names uploading
        'file_encoding' => 'UTF-8',
        ...
        'license_server' => 'http://magester.com.br/list.php',
        'api' => '1',
        'math_content' => '0',
        ...
        'username_format' => '#surname# #n#. (#login#)', //Possible values: #name#, #n#, #surname#, #login#
            ...
            //Multiple logins
            'multiple_logins' => '',
            //0: Enabled, 1: disabled for students, 2: disabled for students and professors, 3: disabled for all
            'mapped_accounts' => '0',
            //Global disable
            'disable_projects' => '0',
            'disable_bookmarks' => '0',
            ...
            'help_url' => 'http://docs.magester.net/index.php',
     ...
     * <br>Example:
     * <code>
     * $defaultConfig = MagesterConfiguration::getValues();
     * </code>
     *
     ...
     * <br/>Example:
     * <code>
     * $defaultConfig = MagesterConfiguration::getDefaultValues();
     * </code>
     *
     ...
     * <br/>Example:
     * <code>
     * //Set the configuration parameter 'smtp_host' to 'localhost'
     * $defaultConfig = MagesterConfiguration::setValue('smtp_host', 'localhost');
     * </code>
     *
