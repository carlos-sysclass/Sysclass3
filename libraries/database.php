...
function escapemaDBFieldsArray($field)
{
...
{
    return StaticBCController::_getTableData($table, $fields, $where, $order, $group, $limit);
}
...
{
    return StaticBCController::_getTableDataFlat($table, $fields, $where, $order, $group);
