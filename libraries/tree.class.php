 ...
 */
class MagesterTreeException extends Exception
{
...
abstract class MagesterTree
{
    ...
    public function seekNode($queryNode)
    {
        ...
        if ($iterator -> valid()) {
            ...
            throw new MagesterTreeException(_NODEDOESNOTEXIST.': '.$queryNode, MagesterTreeException :: NODE_NOT_EXISTS);
        }
    }
    /**
 ...
 */
class MagesterAttributesOnlyFilterIterator extends FilterIterator
{
    /**
 ...
 * WARNING: Cannot be used in conjuction with MagesterNodeFilterIterator!
 ...
 */
class MagesterAttributeFilterIterator extends FilterIterator
{
 /**
