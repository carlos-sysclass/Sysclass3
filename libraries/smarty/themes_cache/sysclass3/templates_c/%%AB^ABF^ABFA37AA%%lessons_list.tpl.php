<?php /* Smarty version 2.6.26, created on 2012-06-05 16:16:48
         compiled from includes/lessons_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'includes/lessons_list.tpl', 6, false),array('modifier', 'replace', 'includes/lessons_list.tpl', 149, false),array('function', 'eF_template_printBlock', 'includes/lessons_list.tpl', 37, false),)), $this); ?>
<script>
...
unset($_smarty_tpl_vars);
 ?>
      ...
      <?php if ($this->_tpl_vars['T_SUPERVISOR_APPROVALS']): ?>
                 <td class = "lessonListOption"><a href = "javascript:void(0)" title="<?php echo @_SUPERVISORAPPROVAL; ?>
" onclick = "eF_js_showDivPopup('<?php echo @_SUPERVISORAPPROVAL; ?>
', 2, 'supervisor_approvals_list')"><img class = "handle" src = "images/32x32/success.png" title = "<?php echo @_SUPERVISORAPPROVAL; ?>
" alt = "<?php echo @_SUPERVISORAPPROVAL; ?>
"></a></td>
                 <td>
                  <script>translations['_SOMEPROBLEMOCCURED'] = '<?php echo @_SOMEPROBLEMOCCURED; ?>
';</script>
                  <a href = "javascript:void(0)" title="<?php echo @_SUPERVISORAPPROVAL; ?>
" onclick = "eF_js_showDivPopup('asd', 1, 'supervisor_approvals_list')"><?php echo @_SUPERVISORAPPROVAL; ?>
</a>
...
')" /></td></tr>
      ...
      <?php if ($this->_tpl_vars['T_CURRENT_USER']->coreAccess['dashboard'] != 'hidden'): ?>
                 <td class = "lessonListOption"><a href = "<?php echo $_SERVER['PHP_SELF']; ?>
?ctg=personal" title="<?php echo @_MYACCOUNT; ?>
"><img class = "handle" src = "images/32x32/user.png" title = "<?php echo @_MYACCOUNT; ?>
" alt = "<?php echo @_MYACCOUNT; ?>
"></a></td>
...
"><?php echo @_MYACCOUNT; ?>
      ...
      <?php endif; ?>
            <?php if ($this->_tpl_vars['T_SKILLGAP_TESTS']): ?>
                 <td class = "lessonListOption"><a href = "student.php?ctg=lessons&op=tests" title="<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
"><img class = "handle" src = "images/32x32/skill_gap.png" title = "<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
" alt = "<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
" ></a></td>
                 <td><a href = "student.php?ctg=lessons&op=tests" title="<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
"><?php echo @_NEWSKILLGAPTESTS; ?>
</a></td>
            <?php endif; ?>

       <?php if ($this->_tpl_vars['T_CONFIGURATION']['insert_group_key'] != 0): ?>
                  <td class = "lessonListOption"><a href = "javascript:void(0)" onclick = "eF_js_showDivPopup('<?php echo @_ENTERGROUPKEY; ?>
', 0, 'group_key_enter')" title = "<?php echo @_ENTERGROUPKEY; ?>
"><img class = "handle" src = "images/32x32/key.png" title = "<?php echo @_ENTERGROUPKEY; ?>
" alt = "<?php echo @_ENTERGROUPKEY; ?>
" /></a></td>
                    <td><a href = "javascript:void(0)" onclick = "eF_js_showDivPopup('<?php echo @_ENTERGROUPKEY; ?>
', 0, 'group_key_enter')" title = "<?php echo @_ENTERGROUPKEY; ?>
"><?php echo @_ENTERGROUPKEY; ?>
</a></td>
                <?php endif; ?>

            <?php if ($this->_tpl_vars['T_CONFIGURATION']['lessons_directory'] != 0): ?>
                 <td class = "lessonListOption"><a href = "<?php echo $_SERVER['PHP_SELF']; ?>
?ctg=lessons&catalog=1"><img class = "handle" src = "images/32x32/catalog.png" title = "<?php echo @_LESSONSDIRECTORY; ?>
" alt = "<?php echo @_LESSONSDIRECTORY; ?>
" ></a></td>
                 <td><a href = "<?php echo $_SERVER['PHP_SELF']; ?>
?ctg=lessons&catalog=1"><?php echo @_COURSECATALOG; ?>
</a></td>
            <?php endif; ?>
...
?ctg=lessons&catalog=1"><?php echo @_LESSONSDIRECTORY; ?>
           ...
           <?php endif; ?>
           <?php if ($this->_tpl_vars['T_CONFIGURATION']['insert_group_key']): ?>
               <tr><td class = "lessonListOption">
                   <a href = "javascript:void(0)" onclick = "eF_js_showDivPopup('<?php echo @_ENTERGROUPKEY; ?>
', 0, 'group_key_enter')" title = "<?php echo @_ENTERGROUPKEY; ?>
"><img class = "handle" src = "images/32x32/key.png" title = "<?php echo @_ENTERGROUPKEY; ?>
" alt = "<?php echo @_ENTERGROUPKEY; ?>
" /></a>
                   <div><a href = "javascript:void(0)" onclick = "eF_js_showDivPopup('<?php echo @_ENTERGROUPKEY; ?>
', 0, 'group_key_enter')" title = "<?php echo @_ENTERGROUPKEY; ?>
"><?php echo @_ENTERGROUPKEY; ?>
</a></div>
               </td></tr>
           <?php endif; ?>
           <?php if ($this->_tpl_vars['T_SKILLGAP_TESTS']): ?>
               <tr><td class = "mediumHeader lessonListOption"><?php echo @_COMPLETETHESKILLGAPTESTSBELOWSOTHATWECANASSIGNLESSONS; ?>
</td></tr>
               <tr><td>
                <a href = "student.php?ctg=lessons&op=tests" title="<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
"><img class = "handle" src = "images/32x32/skill_gap.png" title = "<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
" alt = "<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
" ></a>
                <div><a href = "student.php?ctg=lessons&op=tests" title="<?php echo $this->_tpl_vars['T_SKILLGAP_TESTS']; ?>
"><?php echo @_NEWSKILLGAPTESTS; ?>
</a></div>
           <?php elseif ($this->_tpl_vars['T_SKILLGAP_TESTS_SOLVED']): ?>
               <tr><td class = "mediumHeader lessonListOption"><?php echo @_YOUHAVECOMPLETEDALLSKILLGAPSTESTSASSIGNEDTOYOUWAITTOBEASSIGNEDLESSONS; ?>
</td></tr>
           <?php elseif (! $this->_tpl_vars['T_CONFIGURATION']['lessons_directory'] && ! $this->_tpl_vars['T_CONFIGURATION']['insert_group_key']): ?>
            <tr><td class = "mediumHeader lessonListOption"><?php echo @_THEADMINISTRATORWILLASSIGNYOULESSONS; ?>
</td></tr>
           <?php endif; ?>
        </table>
