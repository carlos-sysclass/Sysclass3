<?php /* Smarty version 2.6.26, created on 2012-06-08 14:43:12
         compiled from includes/forum.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eF_template_printBlock', 'includes/forum.tpl', 49, false),array('function', 'cycle', 'includes/forum.tpl', 220, false),array('modifier', 'eF_truncate', 'includes/forum.tpl', 440, false),)), $this); ?>
...
:&nbsp;</td>
             ...
             <tr><td class = "labelCell"><?php echo @_COURSECLASS; ?>
:&nbsp;</td>
                 <td class = "elementCell"><?php echo $this->_tpl_vars['T_ENTITY_FORM']['classe_ID']['html']; ?>
</td></tr>    
...
" />&nbsp;
     <a href = "javascript:toggleEditor('comments','simpleEditor');" id = "toggleeditor_link"><?php echo @_TOGGLEHTMLEDITORMODE; ?>
</a>
    </span>
    </td></tr>
...
" alt = "<?php echo @_TOGGLEHTMLEDITORMODE; ?>
" />&nbsp;
     <a href = "javascript:toggleEditor('message','simpleEditor');" id = "toggleeditor_link"><?php echo @_TOGGLEHTMLEDITORMODE; ?>
</a>
    </span>
    </td></tr>
...
" alt = "<?php echo @_TOGGLEHTMLEDITORMODE; ?>
" />&nbsp;
     <a href = "javascript:toggleEditor('poll_text','simpleEditor');" id = "toggleeditor_link"><?php echo @_TOGGLEHTMLEDITORMODE; ?>
</a>
    </span>
    </td></tr>
...
" alt = "<?php echo @_TOGGLEHTMLEDITORMODE; ?>
" />&nbsp;
       <a href = "javascript:toggleEditor('editor_message_data','simpleEditor');" id = "toggleeditor_link"><?php echo @_TOGGLEHTMLEDITORMODE; ?>
</a>
      </span>
     </td></tr>
...
', 1)" target = "POPUP_FRAME" ><?php echo @_NEWMESSAGE; ?>
    ...
    <div class="clear"></div>
                <?php endif; ?>
    <table class = "forumMessageTable style1" style = "width:100%">
...
', 'message')"/>
                  ...
                  <?php endif; ?>
                     ...
                     <td class = "forumMessageCreator">
                      <div>
                      	<img src = "view_file.php?file=<?php echo $this->_tpl_vars['T_POSTS'][$this->_sections['messages_list']['index']]['avatar']; ?>
   ...
   <?php ob_start(); ?>
       <?php if ($this->_tpl_vars['T_ACTION'] == 'view' || ! $this->_tpl_vars['T_POLL']['isopen']): ?>
           ...
           <table width="100%">
               ...
               <tr><td>&nbsp;</td></tr>
               <?php if ($this->_tpl_vars['T_CURRENT_POLL_USER_TYPE'] == 'professor' || $this->_tpl_vars['T_CURRENT_POLL_USER_TYPE'] == 'administrator'): ?>
               <tr><td colspan="100%">
	           	<ul class="xenrollment-register-checklist" style="list-style: none;">
...
?>
		           	<li style="border-bottom: 2px solid">
		           		...
		           		<span class="poll_vote" style="width: 30%; display: inline-block;"><?php echo $this->_tpl_vars['T_POLL_VOTES'][$this->_sections['votes_list']['index']]['text']; ?>
</span>
		           		<span class="poll_vote" style="width: 30%; display: inline-block;">
		           			<img src="images/others/bar.jpg" width="<?php echo $this->_tpl_vars['T_POLL_VOTES'][$this->_sections['votes_list']['index']]['width']; ?>
" height="15"/>
							<?php echo $this->_tpl_vars['T_POLL_VOTES'][$this->_sections['votes_list']['index']]['perc']*100; ?>
%
						</span>
						<?php echo $this->_tpl_vars['T_POLL_VOTES']['users']; ?>

						<ul>
							<li>Alunos desta opção</li>
						<?php $_from = $this->_tpl_vars['T_POLL_VOTES'][$this->_sections['votes_list']['index']]['users']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['users_votes_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['users_votes_list']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['login']):
        $this->_foreach['users_votes_list']['iteration']++;
?>
							<li><a href="<?php echo $this->_tpl_vars['T_CURRENT_POLL_USER_TYPE']; ?>
.php?ctg=module&op=module_xuser&action=edit_xuser&xuser_login=<?php echo $this->_tpl_vars['login']; ?>
"><?php echo $this->_tpl_vars['login']; ?>
</a></li>
						<?php endforeach; else: ?>
							<li>Nenhuma vez escolhida</li>
...
', 1)" target = "POPUP_FRAME"><?php echo @_NEWTOPIC; ?>
</a>
     <?php endif; ?>
     </span>
...
', 2)" target = "POPUP_FRAME"><?php echo @_NEWPOLL; ?>
</a>
      <?php endif; ?>
     </span>
     <?php endif; ?>
...
', 'poll')"/>
                     ...
                     <?php endif; unset($_from); ?>
                                     ...
                                     <br/>
                 <?php endif; ?>
                 <?php if ($this->_tpl_vars['T_FORUM_TOPICS'] || ( ! $this->_tpl_vars['T_HAS_SUBFORUMS'] && ! $this->_tpl_vars['T_FORUM_POLLS'] )): ?>                                      <table class = "style1 forumTable">
                                         <tr>
                                             <td class = "topTitle firstColumn"><?php echo @_TOPICS; ?>
</td>
                                             <td class = "topTitle secondColumn"><?php echo @_MESSAGES; ?>
</td>
                                             <td class = "topTitle thirdColumn"><?php echo @_LASTPOST; ?>
</td>
                                             <td class = "topTitle toolsColumn"><?php echo @_STATUS; ?>
</td>
                                             <td class = "topTitle toolsColumn noSort"><?php if ($this->_tpl_vars['_change_'] && ! $this->_tpl_vars['_student_']): ?><?php echo @_OPERATIONS; ?>
<?php endif; ?></td>
                                         </tr>
      <?php $this->assign('novisible', 0); ?>
                     <?php $_from = $this->_tpl_vars['T_FORUM_TOPICS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['topics_list'] = array('total' => count($_from), 'iteration' => 0);
...
', 'topic')"/>
       ...
       <?php endif; ?>
             ...
             <?php else: ?>
                 <table class = "style1 forumTable">
                     <tr>
                         <td class = "topTitle firstColumn"><?php echo @_FORUMS; ?>
</td>
                         <td class = "topTitle secondColumn"><?php echo @_ACTIVITY; ?>
</td>
                         <td class = "topTitle thirdColumn"><?php echo @_LASTPOST; ?>
</td>
       <td class = "topTitle toolsColumn"><?php echo @_STATUS; ?>
       ...
       <?php if ($this->_tpl_vars['_change_'] && $this->_tpl_vars['_admin_']): ?>
        <td class = "topTitle toolsColumn noSort"><?php echo @_OPERATIONS; ?>
</td>
       <?php endif; ?>
                     </tr>
                    <?php $_from = $this->_tpl_vars['T_FORUMS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['subforums_list'] = array('total' => count($_from), 'iteration' => 0);
