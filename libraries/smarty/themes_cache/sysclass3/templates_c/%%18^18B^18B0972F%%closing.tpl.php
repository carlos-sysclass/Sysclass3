<?php /* Smarty version 2.6.26, created on 2012-06-08 14:11:43
         compiled from includes/closing.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'eF_template_printBlock', 'includes/closing.tpl', 60, false),array('modifier', 'basename', 'includes/closing.tpl', 177, false),array('modifier', 'replace', 'includes/closing.tpl', 177, false),)), $this); ?>
...
<script type = "text/javascript" src = "modules/module_language/js/language.js.php"> </script> <!-- 	<script type = "text/javascript" src = "<?php echo $this->_tpl_vars['item']; ?>
"> </script>  -->

<?php if (isset ( $this->_tpl_vars['T_MODULE_JS_STRING'] )): ?>
	<script type = "text/javascript" src="/min/f=<?php echo $this->_tpl_vars['T_MODULE_JS_STRING']; ?>
,themes/<?php echo $this->_tpl_vars['T_THEME_SETTINGS']->themes['path']; ?>
js/sysclass.js,js/script.js,js/script_jquery.js"></script> <?php else: ?>
	<script type = "text/javascript" src="/min/f=themes/<?php echo $this->_tpl_vars['T_THEME_SETTINGS']->themes['path']; ?>
js/sysclass.js,js/script.js,js/script_jquery.js"></script> 	
<?php endif; ?>

	<?php $_from = $this->_tpl_vars['T_HEADER_INJECT_SCRIPTS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<?php echo smarty_function_eF_template_printBlock(array('title' => @_ERRORDETAILS,'data' => ($this->_tpl_vars['T_EXCEPTION_TRACE']),'image' => '32x32/error_delete.png'), $this);?>
</div>
