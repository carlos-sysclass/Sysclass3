<?php /* Smarty version 2.6.26, created on 2012-06-05 16:17:06
...
?>
                    ...
                    <?php ob_start(); ?>
                        <li id = "secondlist_<?php echo ((is_array($_tmp=$this->_tpl_vars['class_name'])) ? $this->_run_mod_handler('replace', true, $_tmp, '_', "") : smarty_modifier_replace($_tmp, '_', "")); ?>
">
                            <table class = "innerTable" style = "width:300px">
                                <tr class = "handle">
                                    <th class = "innerTableHeader">
            ...
            <div id = "sortableList" class = "lessonLayout">
             <table>
              <tr><td>
                      ...
                      <?php if (! in_array ( 'moduleIconFunctions' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleIconFunctions' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleIconFunctions']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleContentTree' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleContentTree' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleContentTree']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleProjectsList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleProjectsList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleProjectsList']; ?>
<?php endif; ?>
...
?>
                      ...
                      <?php if (! in_array ( 'moduleNewsList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleNewsList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleNewsList']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'modulePersonalMessagesList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'modulePersonalMessagesList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_modulePersonalMessagesList']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleForumList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleForumList' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleForumList']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleComments' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleComments' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleComments']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleCalendar' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleCalendar' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleCalendar']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleDigitalLibrary' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleDigitalLibrary' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleDigitalLibrary']; ?>
<?php endif; ?>
                      <?php if (! in_array ( 'moduleTimeline' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['first'] ) && ! in_array ( 'moduleTimeline' , $this->_tpl_vars['T_DEFAULT_POSITIONS']['second'] )): ?><?php echo $this->_smarty_vars['capture']['layout_moduleTimeline']; ?>
<?php endif; ?>
