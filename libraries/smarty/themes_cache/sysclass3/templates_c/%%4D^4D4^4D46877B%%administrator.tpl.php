...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'administrator.tpl', 28, false),array('function', 'eF_template_printBlock', 'administrator.tpl', 241, false),array('function', 'eF_template_printMessageBlock', 'administrator.tpl', 565, false),)), $this); ?>
 ...
 ?>
	...
	<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'user_profile' )): ?>
		...
		<?php if ($_GET['edit_field']): ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=user_profile&edit_field=') : smarty_modifier_cat($_tmp, '?ctg=user_profile&edit_field=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['edit_field']) : smarty_modifier_cat($_tmp, $_GET['edit_field'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_EDITFIELD) : smarty_modifier_cat($_tmp, @_EDITFIELD)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php elseif ($_GET['add_field']): ?>
			<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=user_profile&add_field=1">') : smarty_modifier_cat($_tmp, '?ctg=user_profile&add_field=1">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_ADDFIELD) : smarty_modifier_cat($_tmp, @_ADDFIELD)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php endif; ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'logout_user' )): ?>
		<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;')))) ? $this->_run_mod_handler('cat', true, $_tmp, '<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=logout_user">') : smarty_modifier_cat($_tmp, '?ctg=logout_user">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_LOGOUTUSER) : smarty_modifier_cat($_tmp, @_LOGOUTUSER)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
		<?php ob_start(); ?>
		<tr><td class = "moduleCell">
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
		...
		<?php $this->_smarty_vars['capture']['moduleLogoutUser'] = ob_get_contents(); ob_end_clean(); ?>
	<?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
	<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'chat' )): ?>
		<?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href = '".($_SERVER['PHP_SELF'])."?ctg=chat'>".(@_CHAT)."</a>"); ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "includes/chat.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
	<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && ( $this->_tpl_vars['T_CTG'] == 'users' || $this->_tpl_vars['T_CTG'] == 'personal' ) )): ?>
		...
		<?php if ($_GET['add_user'] || $_GET['edit_user']): ?>
			<?php if (! isset ( $_GET['print_preview'] ) && ! isset ( $_GET['print'] ) && ! $this->_tpl_vars['T_POPUP_MODE']): ?>
				<?php if ($_GET['edit_user'] != ""): ?>
					<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=users&edit_user=') : smarty_modifier_cat($_tmp, '?ctg=users&edit_user=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['edit_user']) : smarty_modifier_cat($_tmp, $_GET['edit_user'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_EDITUSEREDIT) : smarty_modifier_cat($_tmp, @_EDITUSEREDIT)))) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;<span class="innerTableName">&quot;') : smarty_modifier_cat($_tmp, '&nbsp;<span class="innerTableName">&quot;')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['edit_user']) : smarty_modifier_cat($_tmp, $_GET['edit_user'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '&quot;</span></a>') : smarty_modifier_cat($_tmp, '&quot;</span></a>'))); ?>
				<?php else: ?>
					<?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=users&add_user=1">') : smarty_modifier_cat($_tmp, '?ctg=users&add_user=1">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_NEWUSER) : smarty_modifier_cat($_tmp, @_NEWUSER)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
				<?php endif; ?>
			<?php endif; ?>
		<?php endif; ?>
	...
	<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'tests' )): ?>
		...
		<?php elseif ($_GET['show_solved_test']): ?>
			...
			<?php if (! $_GET['test_analysis']): ?>
				<?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href = '".($_SERVER['PHP_SELF'])."?ctg=tests&show_solved_test=".($this->_tpl_vars['T_TEST_DATA']->completedTest['id'])."'>".(@_VIEWSOLVEDTEST).": &quot;".($this->_tpl_vars['T_TEST_DATA']->test['name'])."&quot; ".(@_BYUSER).": #filter:login-".($this->_tpl_vars['T_TEST_DATA']->completedTest['login'])."#</a>"); ?>
			<?php else: ?>
...
<?php if (( isset ( $this->_tpl_vars['T_CATEGORY'] ) && $this->_tpl_vars['T_CATEGORY'] == 'statistics' )): ?>
    <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics">') : smarty_modifier_cat($_tmp, '?ctg=statistics">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_STATISTICS) : smarty_modifier_cat($_tmp, @_STATISTICS)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
        ...
        <?php if ($_GET['sel_user']): ?>
            <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=user&sel_user=') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=user&sel_user=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['sel_user']) : smarty_modifier_cat($_tmp, $_GET['sel_user'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">#filter:login-') : smarty_modifier_cat($_tmp, '">#filter:login-')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['sel_user']) : smarty_modifier_cat($_tmp, $_GET['sel_user'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '#</a>') : smarty_modifier_cat($_tmp, '#</a>'))); ?>
        <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php endif; ?>
		<?php if (! $this->_tpl_vars['T_LAYOUT_CLASS']): ?><?php $this->assign('layoutClass', 'centerFull'); ?><?php else: ?><?php $this->assign('layoutClass', $this->_tpl_vars['T_LAYOUT']); ?><?php endif; ?>
<?php ob_start(); ?>
...
<?php endif; ?>
	...
	<?php echo $this->_smarty_vars['capture']['chatRoomOptions']; ?>

<?php $this->_smarty_vars['capture']['center_code'] = ob_get_contents(); ob_end_clean(); ?>
<?php ob_start(); ?>
	<?php if (! $this->_tpl_vars['layoutClass'] || $this->_tpl_vars['layoutClass'] == 'hideRight'): ?>
		<div>
		</div>
	<?php endif; ?>
<?php $this->_smarty_vars['capture']['left_code'] = ob_get_contents(); ob_end_clean(); ?>
<?php ob_start(); ?>
	<?php if (! $this->_tpl_vars['layoutClass'] || $this->_tpl_vars['layoutClass'] == 'hideLeft'): ?>
		<div>
		</div>
	<?php endif; ?>
