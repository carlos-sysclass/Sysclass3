<?php /* Smarty version 2.6.26, created on 2012-06-05 13:10:43
         compiled from includes/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'includes/header.tpl', 2, false),array('modifier', 'replace', 'includes/header.tpl', 36, false),)), $this); ?>
...
" /> -->
		...
		<!-- /end new admin -->
		<?php if (isset ( $this->_tpl_vars['T_MODULE_CSS_STRING'] )): ?>
			<link type="text/css" rel="stylesheet" href="/min/f=<?php echo $this->_tpl_vars['T_MODULE_CSS_STRING']; ?>
" />
		<?php endif; ?>
		<!-- 			<link rel = "stylesheet" type = "text/css" href = "<?php echo $this->_tpl_vars['item']; ?>
?build=<?php echo @G_BUILD; ?>
" />   -->
				<?php if ($this->_tpl_vars['T_HEADER_LOAD_STYLESHEETS']): ?>
			<link rel = "stylesheet" type = "text/css" href = "css/stylesheets.php?build=<?php echo @G_BUILD; ?>
&load=<?php echo $this->_tpl_vars['T_HEADER_LOAD_STYLESHEETS']; ?>
" />
		<?php endif; ?>
		<title><?php if ($this->_tpl_vars['T_CONFIGURATION']['site_name']): ?><?php echo $this->_tpl_vars['T_CONFIGURATION']['site_name']; ?>
<?php else: ?><?php echo @_MAGESTERNAME; ?>
...
<?php else: ?><?php echo @_MAGESTERNAME; ?>
<?php endif; ?> | <?php if ($this->_tpl_vars['T_TITLE_BAR']): ?><?php echo $this->_tpl_vars['T_TITLE_BAR']; ?>
<?php else: ?><?php if ($this->_tpl_vars['T_CONFIGURATION']['site_motto']): ?><?php echo $this->_tpl_vars['sitemotto']; ?>
<?php else: ?><?php echo @_THENEWFORMOFADDITIVELEARNING; ?>
<?php endif; ?><?php endif; ?>";
...
"<?php elseif (((is_array($_tmp=$_SERVER['PHP_SELF'])) ? $this->_run_mod_handler('basename', true, $_tmp) : basename($_tmp)) == 'index.php'): ?>id = "index_page"<?php endif; ?> onkeypress = "if (window.eF_js_keypress) eF_js_keypress(event);" onbeforeunload = "if (window.getPeriodicData) getPeriodicData();" <?php if ($this->_tpl_vars['_admin_']): ?> class="admin_page"<?php endif; ?>>
	<?php endif; ?>
