<?php /* Smarty version 2.6.26, created on 2012-06-08 14:16:11
         compiled from includes/common/courses_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'includes/common/courses_list.tpl', 67, false),array('modifier', 'sizeof', 'includes/common/courses_list.tpl', 250, false),)), $this); ?>
<?php ob_start(); ?>
<style>
<?php echo '
...
table#coursesTable td.price,table#instancesTable td.price,
table#coursesTable td.price_presencial,table#instancesTable td.price_presencial,
table#coursesTable td.price_web,table#instancesTable td.price_web {width:10%;text-align:center;}
...
<?php if (in_array ( 'price_presencial' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] ) && $this->_tpl_vars['T_CONFIGURATION']['disable_payments'] != 1): ?> <td class = "topTitle price_presencial" name = "price_presencial"><?php echo @_PRICE_PRESENCIAL; ?>
</td><?php endif; ?>
<?php if (in_array ( 'price_web' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] ) && $this->_tpl_vars['T_CONFIGURATION']['disable_payments'] != 1): ?> <td class = "topTitle price_web" name = "price_web"><?php echo @_PRICE_WEB; ?>
</td><?php endif; ?>
<?php if (in_array ( 'price' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] ) && $this->_tpl_vars['T_CONFIGURATION']['disable_payments'] != 1): ?> <td class = "topTitle price" name = "price"><?php echo @_PRICE; ?>
</td><?php endif; ?>
...
<?php endif; ?>
<?php if (in_array ( 'price_presencial' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] ) && $this->_tpl_vars['T_CONFIGURATION']['disable_payments'] != 1): ?>
   <td class = "price_presencial">
    <?php if ($this->_tpl_vars['course']['price_presencial'] == 0): ?>-<?php else: ?><?php echo $this->_tpl_vars['course']['price_presencial_string']; ?>
<?php endif; ?>
   </td>
<?php endif; ?>
<?php if (in_array ( 'price_web' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] ) && $this->_tpl_vars['T_CONFIGURATION']['disable_payments'] != 1): ?>
   <td class = "price_web">
    <?php if ($this->_tpl_vars['course']['price_web'] == 0): ?>-<?php else: ?><?php echo $this->_tpl_vars['course']['price_web_string']; ?>
<?php endif; ?>
   </td>
<?php endif; ?>
...
" <?php if ($this->_tpl_vars['_change_handles_']): ?>class = "ajaxHandle" onclick = "confirmUser(this, '<?php echo $this->_tpl_vars['course']['id']; ?>
', 'course')"<?php endif; ?>/>
...
" <?php if ($this->_tpl_vars['_change_handles_']): ?>class = "ajaxHandle" onclick = "unConfirmUser(this, '<?php echo $this->_tpl_vars['course']['id']; ?>
', 'course')"<?php endif; ?>/>
             <?php endif; ?>
         </td>
<?php endif; ?>
...
<?php if (in_array ( 'active_in_lesson' , $this->_tpl_vars['T_DATASOURCE_COLUMNS'] )): ?>
   <td class = "active_in_lesson">
    <?php if (! $this->_tpl_vars['lesson']['active_in_lesson'] && $this->_tpl_vars['lesson']['has_lesson']): ?>
              <img src = "images/16x16/warning.png" title = "<?php echo @_APPLICATIONPENDING; ?>
" alt = "<?php echo @_APPLICATIONPENDING; ?>
" <?php if ($this->_tpl_vars['_change_handles_']): ?>class = "ajaxHandle" onclick = "confirmUser(this, '<?php echo $this->_tpl_vars['lesson']['id']; ?>
', 'lesson')"<?php endif; ?>/>
             <?php elseif ($this->_tpl_vars['lesson']['has_lesson']): ?>
              <img src = "images/16x16/success.png" title = "<?php echo @_USERHASTHElesson; ?>
" alt = "<?php echo @_USERHASTHElesson; ?>
" <?php if ($this->_tpl_vars['_change_handles_']): ?>class = "ajaxHandle" onclick = "unConfirmUser(this, '<?php echo $this->_tpl_vars['lesson']['id']; ?>
', 'lesson')"<?php endif; ?>/>
             <?php endif; ?>
   </td>
<?php endif; ?>
...
<!--ajax:courseLessonsTable-->
  <table id = "courseLessonsTable" no_auto = "1" size = "<?php echo $this->_tpl_vars['T_TABLE_SIZE']; ?>
