<?php /* Smarty version 2.6.26, created on 2012-06-12 15:04:24
         compiled from includes/modules.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'includes/modules.tpl', 26, false),array('function', 'eF_template_printBlock', 'includes/modules.tpl', 60, false),)), $this); ?>
        <?php ob_start(); ?>
...
', 0, 'upload_file_table')" title = "<?php echo @_INSTALLMODULE; ?>
...
<!--                                    <td><?php echo $this->_tpl_vars['T_MODULES'][$this->_sections['modules_list']['index']]['author']; ?>
                                    ...
                                    <td><?php echo $this->_tpl_vars['T_MODULES'][$this->_sections['modules_list']['index']]['version']; ?>
</td>
...
:&nbsp;</td>
 ...
 <b><?php echo @G_MAXFILESIZE/1024; ?>
                                        ...
                                        <tr><td class = "labelCell"><?php echo $this->_tpl_vars['T_UPLOAD_FILE_FORM']['overwrite']['label']; ?>
:&nbsp;</td>
