<?php /* Smarty version 2.6.26, created on 2012-06-05 16:16:47
         compiled from professor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'professor.tpl', 12, false),array('modifier', 'eF_truncate', 'professor.tpl', 280, false),array('function', 'eF_template_printBlock', 'professor.tpl', 749, false),array('function', 'eF_template_printMessageBlock', 'professor.tpl', 753, false),)), $this); ?>
...
<?php if ($_SESSION['s_lessons_ID']): ?>
 <?php $this->assign('lessonName', $this->_tpl_vars['T_CURRENT_LESSON']->lesson['name']); ?>
  ...
  <?php if (isset ( $this->_tpl_vars['T_CURRENT_COURSE_NAME'] )): ?>
   <?php $this->assign('titleCourse', ($this->_tpl_vars['T_CURRENT_COURSE_NAME'])."&nbsp;&rarr;&nbsp;"); ?>
   <?php $this->assign('title', ($this->_tpl_vars['title'])."<a class = 'titleLink' title = '".($this->_tpl_vars['T_CURRENT_COURSE_NAME'])."' href ='".($_SERVER['PHP_SELF'])."?ctg=lessons&course=".($this->_tpl_vars['T_CURRENT_COURSE_ID'])."&op=course_info'>".($this->_tpl_vars['T_CURRENT_COURSE_NAME'])."</a><span>&nbsp;&raquo;&nbsp;</span>"); ?>
  <?php endif; ?>
  <?php $this->assign('title', ($this->_tpl_vars['title'])."<a class = 'titleLink' title = '".($this->_tpl_vars['T_CURRENT_CATEGORY_PATH'])."&nbsp;&rarr;&nbsp;".($this->_tpl_vars['titleCourse']).($this->_tpl_vars['T_CURRENT_LESSON']->lesson['name'])."' href ='".($_SERVER['PHP_SELF'])."?ctg=control_panel'>".($this->_tpl_vars['lessonName'])."</a>"); ?>
<?php else: ?>
...
<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'progress' )): ?>
 ...
 <?php if ($_GET['edit_user']): ?>
  <?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href ='".($_SERVER['PHP_SELF'])."?ctg=progress&edit_user=".($_GET['edit_user'])."'>".(@_PROGRESSFORUSER).": #filter:login-".($this->_tpl_vars['T_USER_LESSONS_INFO']['users_LOGIN'])."#</a>"); ?>
 <?php endif; ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php if (( isset ( $this->_tpl_vars['T_CTG'] ) && $this->_tpl_vars['T_CTG'] == 'feedback' )): ?>                         <?php ob_start(); ?>
                            ...
                            <?php elseif ($_GET['add_test']): ?>
                                <?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href = '".($_SERVER['PHP_SELF'])."?ctg=feedback&add_test=1'>".(@_ADDFEEDBACK)."</a>"); ?>
                            <?php elseif ($_GET['edit_question']): ?>
        ...
        <?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href = '".($_SERVER['PHP_SELF'])."?ctg=feedback&test_results=".($_GET['test_results'])."'>&quot;".($this->_tpl_vars['T_TEST']->test['name'])."&quot; ".(@_RESULTS)."</a>"); ?>
                <?php elseif ($_GET['view_unit']): ?>
                    <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href ="')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?view_unit=') : smarty_modifier_cat($_tmp, '?view_unit=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['view_unit']) : smarty_modifier_cat($_tmp, $_GET['view_unit'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_PREVIEW) : smarty_modifier_cat($_tmp, @_PREVIEW)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
                            <?php elseif ($_GET['show_solved_test']): ?>
                                <?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href = '".($_SERVER['PHP_SELF'])."?ctg=feedback&test_results=".($this->_tpl_vars['T_TEST_DATA']->completedTest['testsId'])."'>".(@_TESTRESULTS)."</a>"); ?>
                                <?php if (! $_GET['test_analysis']): ?>
                                    <?php $this->assign('title', ($this->_tpl_vars['title'])."&nbsp;&raquo;&nbsp;<a class = 'titleLink' href = '".($_SERVER['PHP_SELF'])."?ctg=feedback&show_solved_test=".($this->_tpl_vars['T_TEST_DATA']->completedTest['id'])."'>".(@_VIEWSOLVEDTEST).": &quot;".($this->_tpl_vars['T_TEST_DATA']->test['name'])."&quot; ".(@_BYUSER).": #filter:login-".($this->_tpl_vars['T_TEST_DATA']->completedTest['login'])."#</a>"); ?>
                                <?php else: ?>
...
<?php if ($this->_tpl_vars['T_CTG'] == 'personal'): ?>
    <?php ob_start(); ?>
                            <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=personal">') : smarty_modifier_cat($_tmp, '?ctg=personal">')))) ? $this->_run_mod_handler('cat', true, $_tmp, @_USERPROFILE) : smarty_modifier_cat($_tmp, @_USERPROFILE)))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
 ...
 <?php elseif ($_GET['option'] == 'branches'): ?>
    ...
    <?php elseif ($_GET['option'] == 'course'): ?>
        ...
        <?php if (isset ( $_GET['sel_course'] )): ?>
            <?php $this->assign('title', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('cat', true, $_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "') : smarty_modifier_cat($_tmp, '&nbsp;&raquo;&nbsp;<a class = "titleLink" href = "')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_SERVER['PHP_SELF']) : smarty_modifier_cat($_tmp, $_SERVER['PHP_SELF'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '?ctg=statistics&option=course&sel_course=') : smarty_modifier_cat($_tmp, '?ctg=statistics&option=course&sel_course=')))) ? $this->_run_mod_handler('cat', true, $_tmp, $_GET['sel_course']) : smarty_modifier_cat($_tmp, $_GET['sel_course'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '">') : smarty_modifier_cat($_tmp, '">')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['T_COURSE_INFO']['name']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['T_COURSE_INFO']['name'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '</a>') : smarty_modifier_cat($_tmp, '</a>'))); ?>
        <?php endif; ?>
...
<?php ob_start(); ?>
 <span id = "tab_handles" class = "headerText"><?php if ($this->_tpl_vars['T_THEME_SETTINGS']->options['sidebar_interface'] != 0): ?>&nbsp;|&nbsp;<?php endif; ?>
