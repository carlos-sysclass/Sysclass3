 ...
 * MagesterManifestException class
 ...
 */
class MagesterManifestException extends Exception
{
    const NO_ERROR = 0;
 ...
 * @author Antonellis Panagiotis <antonelli@magester.gr>
...
class MagesterManifest
{
     ...
     * $manifest = new MagesterManifest(32);                     //32 is a lesson id
     ...
     * $unit = new MagesterUnit(10);      //10 is a content id
     ...
     * @param MagesterUnit $unit The unit to be added
     ...
     * $test = new MagesterTest(10);      //10 is a test id
     ...
     * @param MagesterTest $test The test to be added
