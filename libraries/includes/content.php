...
if (!$currentUnit) {
    ...
    try {
        ...
        $visitableAndEmptyIterator = new MagesterVisitableAndEmptyFilterIterator(new MagesterNodeFilterIterator(new RecursiveIteratorIterator(new RecursiveArrayIterator($currentContent -> tree), RecursiveIteratorIterator :: SELF_FIRST)));
