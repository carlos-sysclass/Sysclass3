...
try {
 ...
 $scoLesson = new MagesterLesson($_SESSION['s_lessons_ID']);
 $scoUnit = new MagesterUnit($fields['content_ID']);
 ...
 $newUserProgress = MagesterStats :: getUsersLessonStatus($scoLesson, $scoUser -> user['login']);
