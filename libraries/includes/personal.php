...
*/
 ...
 // CREATE USER DETAILS FIELDS
	...
	$form -> addElement('text', 'cpf', _USER_CPF, 'class = "inputText"');
	$form -> addElement('text', 'cep', _USER_CEP, 'class = "inputText"');
	$form -> addElement('text', 'endereco', _USER_ENDERECO, 'class = "inputText"');
	$form -> addElement('text', 'numero', _USER_NUMERO, 'class = "inputText"');
	$form -> addElement('text', 'complemento', _USER_COMPLEMENTO, 'class = "inputText"');
	$form -> addElement('text', 'bairro', _USER_BAIRRO, 'class = "inputText"');
	$form -> addElement('text', 'cidade', _USER_CIDADE, 'class = "inputText"');
   ...
   try {
    if (isset($_GET['fb_login'])) {
     ...
     if (isset($_GET['delete'])) {
      ...
      $newAccount = MagesterUserFactory::factory($_GET['login'], MagesterUser::createPassword($_GET['pwd']));
