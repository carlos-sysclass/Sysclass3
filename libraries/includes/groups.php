...
$loadScripts[] = 'includes/groups';
    ...
    if (isset($_GET['delete_user_group']) && eF_checkParameter($_GET['delete_user_group'], 'id')) {
        ...
        try {
            $group = new MagesterGroup($_GET['deactivate_user_group']);
        ...
        try {
            $group = new MagesterGroup($_GET['activate_user_group']);
  ...
  array_unshift($roles, _DONTUSEDEFAULTGROUP);
        ...
        $form -> addElement('advcheckbox', 'is_default', _ISTHEDEFAULTMAGESTERSYSTEMGROUP, null, 'class = "inputCheckBox"', array(0, 1));
        $form -> addElement('static', 'note', _ISTHEDEFAULTMAGESTERSYSTEMGROUPINFO);
        ...
        if (isset($_GET['edit_user_group'])) {
            ...
            try {
             ...
             if (isset($_GET['ajax']) && $_GET['ajax'] == "lessonsTable") {
              ...
              $result = MagesterLesson::getStandAloneLessons(true);
     ...
     $_GET['sort'] != 'null' OR $_GET['sort'] = 'has_course';
             ...
             if (isset($_GET['postAjaxRequest'])) {
              ...
              } elseif (isset($_GET['addAll']) && $_GET['table'] == "usersTable") {
               $constraints = array('archive' => false, 'return_objects' => false);// + createConstraintsFromSortedTable();
               $usersToAdd = array();
              ...
              } elseif (isset($_GET['assign_to_all_users']) && $_GET['assign_to_all_users'] == "lessons") {
