...
if (isset($currentUser -> coreAccess['settings']) && $currentUser -> coreAccess['settings' ] != 'change') {
    ...
    if ($form -> isSubmitted() && $form -> validate()) {
        ...
        if ($fromTimestamp < $toTimestamp) {
            ...
            MagesterEvent::triggerEvent(array("type" => MagesterEvent::LESSON_PROGRAMMED_EXPIRY, "timestamp" => $toTimestamp, "lessons_ID" => $currentLesson -> lesson['id'], "lessons_name" => $currentLesson -> lesson['name']));
