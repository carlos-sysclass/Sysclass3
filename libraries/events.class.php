 ...
 *
 */
class MagesterEventException extends Exception
{
    /**
...
/**
 * This class represents a event in SysClass
 *
 * @package SysClass
 * @since 3.6.0
 */
class MagesterEvent
{
     ...
     * <br/>Example:
     * <code>
     * $event = new MagesterEvent(5);       //create object for event with id 5
     * </code>
     *
     ...
     * <br/>Example:
     * <code>
     * MagesterEvent::getEventTypes(false);
     * </code>
     *
    ...
    public static function getEventTypes($get_module_events = false) {
        if (!isset($system_events) || !$system_events) {
            $system_events = array(MagesterEvent::SYSTEM_JOIN => array("text" => _SYSTEMJOIN, "category" => "system", "priority" => 1, "afterEvent" => 1),
                ...
                MagesterEvent::SYSTEM_VISITED => array("text" => _SYSTEM_VISITED, "category" => "system", "canBeNegated" => _SYSTEM_NOT_VISITED, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::SYSTEM_FORGOTTEN_PASSWORD => array("text" => _SYSTEM_ONPASSWORD_FORGOTTEN, "category" => "system"),
                MagesterEvent::SYSTEM_NEW_PASSWORD_REQUEST => array("text" => _SYSTEM_ON_NEW_PASSWORD_REQUEST, "category" => "system"),
                MagesterEvent::SYSTEM_REGISTER => array("text" => _SYSTEM_REGISTERED, "category" => "system"),
                MagesterEvent::SYSTEM_ON_EMAIL_ACTIVATION => array("text" => _SYSTEM_EMAIL_ACTIVATION, "category" => "system"),
                MagesterEvent::SYSTEM_USER_DEACTIVATE => array("text" => _SYSTEM_USER_DEACTIVATED, "category" => "system"),
                MagesterEvent::LESSON_ACQUISITION_AS_STUDENT => array("text" => _LESSON_ACQUISITION_AS_STUDENT, "category" => "lessons", "priority" => 1, "afterEvent" => 1),
                MagesterEvent::LESSON_ACQUISITION_AS_PROFESSOR => array("text" => _LESSON_ACQUISITION_AS_PROFESSOR, "category" => "lessons", "priority" => 1, "afterEvent" => 1),
                MagesterEvent::LESSON_VISITED => array("text" => _LESSON_VISITED, "category" => "lessons", "canBeNegated" => _LESSON_NOT_VISITED, "afterEvent" => 1),
                MagesterEvent::LESSON_REMOVAL => array("text" => _LESSON_REMOVAL, "category" => "lessons"),
                MagesterEvent::LESSON_COMPLETION => array("text" => _LESSON_COMPLETION, "category" => "lessons", "canBeNegated" => _LESSON_NOT_COMPLETED, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::PROJECT_CREATION => array("text" => _NEWLESSONPROJECT, "category" => "lessons", "priority" => 1),
                MagesterEvent::PROJECT_SUBMISSION => array("text" => _PROJECT_SUBMISSION, "category" => "lessons", "priority" => 1, "afterEvent" => 1),
                MagesterEvent::LESSON_PROGRAMMED_START => array("text" => _PROGRAMMEDLESSONSTART, "category" => "lessons", "canBePreceded" => 1, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::LESSON_PROGRAMMED_EXPIRY => array("text" => _PROGRAMMEDLESSONEXPIRY, "category" => "lessons", "canBePreceded" => 1, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::PROJECT_EXPIRY => array("text" => _PROJECTEXPIRY, "category" => "projects", "canBePreceded" => 1, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::COURSE_ACQUISITION_AS_STUDENT => array("text" => _COURSE_ACQUISITION_AS_STUDENT, "category" => "courses", "afterEvent" => 1),
                MagesterEvent::COURSE_ACQUISITION_AS_PROFESSOR => array("text" => _COURSE_ACQUISITION_AS_PROFESSOR, "category" => "courses", "afterEvent" => 1),
                //MagesterEvent::COURSE_VISITED => array("text" => _COURSE_VISITED, "category" => "courses", "canBeNegated" => _COURSE_NOT_VISITED),
                MagesterEvent::COURSE_REMOVAL => array("text" => _COURSE_REMOVAL, "category" => "courses"),
                MagesterEvent::COURSE_COMPLETION => array("text" => _COURSE_COMPLETION, "category" => "courses", "canBeNegated" => _COURSE_NOT_COMPLETED, "afterEvent" => 1),
                MagesterEvent::COURSE_CERTIFICATE_ISSUE => array("text" => _CERTIFICATEISSUE, "category" => "courses", "afterEvent" => 1),
                MagesterEvent::COURSE_CERTIFICATE_REVOKE => array("text" => _CERTIFICATEREVOKE, "category" => "courses"),
                MagesterEvent::COURSE_PROGRAMMED_START => array("text" => _PROGRAMMEDCOURSESTART, "category" => "courses", "canBePreceded" => 1, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::COURSE_PROGRAMMED_EXPIRY => array("text" => _PROGRAMMEDCOURSEEXPIRY, "category" => "courses", "canBePreceded" => 1, "priority" => 1, "afterEvent" => 1),
                MagesterEvent::NEW_POST_FOR_LESSON_TIMELINE_TOPIC => array("text" => _NEW_POST_FOR_LESSON_TIMELINE_TOPIC, "category" => "social"),
                MagesterEvent::DELETE_POST_FROM_LESSON_TIMELINE => array("text" => _DELETE_POST_FROM_LESSON_TIMELINE, "category" => "social"),
                MagesterEvent::TEST_CREATION => array("text" => _TEST_CREATION, "category" => "tests"),
                //MagesterEvent::TEST_START => array("text" => _TEST_START, "category" => "tests"),
                MagesterEvent::TEST_COMPLETION => array("text" => _TEST_COMPLETION, "category" => "tests", "canBeNegated" => _TEST_NOT_COMPLETED),
                MagesterEvent::CONTENT_CREATION => array("text" => _CONTENT_CREATION, "category" => "content"),
                MagesterEvent::CONTENT_MODIFICATION => array("text" => _CONTENT_MODIFICATION, "category" => "content"),
                //MagesterEvent::CONTENT_START => array("text" => _CONTENT_START, "category" => "content"),
                MagesterEvent::CONTENT_COMPLETION => array("text" => _CONTENT_COMPLETION, "category" => "content", "canBeNegated" => _CONTENT_NOT_COMPLETED),
                MagesterEvent::NEW_COMMENT_WRITING => array("text" => _NEW_COMMENT_WRITING, "category" => "content"),
                MagesterEvent::NEW_FORUM => array("text" => _NEW_FORUM, "category" => "forum"),
                MagesterEvent::NEW_TOPIC => array("text" => _NEW_TOPIC, "category" => "forum"),
                MagesterEvent::NEW_POLL => array("text" => _NEW_POLL, "category" => "forum"),
                MagesterEvent::NEW_FORUM_MESSAGE_POST => array("text" => _NEW_FORUM_MESSAGE_POST, "category" => "forum"),
                MagesterEvent::STATUS_CHANGE => array("text" => _STATUS_CHANGE, "category" => "personal"),
                MagesterEvent::AVATAR_CHANGE => array("text" => _AVATAR_CHANGE, "category" => "personal"),
                MagesterEvent::PROFILE_CHANGE => array("text" => _PROFILE_CHANGE , "category" => "personal"),
                MagesterEvent::NEW_PROFILE_COMMENT_FOR_OTHER => array("text" => _NEW_PROFILE_COMMENT_FOR_OTHER, "category" => "personal"),
                MagesterEvent::NEW_PROFILE_COMMENT_FOR_SELF => array("text" => _NEW_PROFILE_COMMENT_FOR_SELF, "category" => "personal"),
                MagesterEvent::DELETE_PROFILE_COMMENT_FOR_SELF => array("text" => _DELETE_PROFILE_COMMENT_FOR_SELF, "category" => "personal"),
                MagesterEvent::NEW_SYSTEM_ANNOUNCEMENT => array("text" => _NEWSYSTEMANNOUNCEMENT, "category" => "news", "priority" => 1),
                MagesterEvent::NEW_LESSON_ANNOUNCEMENT => array("text" => _NEWLESSONANNOUNCEMENT, "category" => "news", "priority" => 1),
                MagesterEvent::NEW_ASSIGNMENT_TO_GROUP => array("text" => _GROUPASSIGNMENT, "category" => "groups"),
                MagesterEvent::REMOVAL_FROM_GROUP => array("text" => _REMOVALFROMGROUP, "category" => "groups"),
                MagesterEvent::NEW_SURVEY => array("text" => _NEWSURVEY, "category" => "survey", "afterEvent" => 1),
                MagesterEvent::NEW_BALANCE_PAYMENT => array("text" => _NEWBALANCEPAYMENT, "category" => "payments"),
                MagesterEvent::NEW_PAYPAL_PAYMENT => array("text" => _NEWPAYPALPAYMENT, "category" => "payments"),
                MagesterEvent::COUPON_USAGE => array("text" => _COUPONUSAGE, "category" => "payments")
            );
   ...
   /**
     ...
     * <br/>Example:
     * <code>
     * $events = MagesterEvent::getEvents('joe');
     * or
     * $events = MagesterEvent::getEvents(array('joe', 'averel', 'jack'));
     * </code>
     *
     * @param $login the login of the associated user or an array of all related users logins
     * @param $returnObjects whether to return MagesterEvent objects or arrays of data from the databaes
     * @param $max how many events to return from the database
     * @return array of DB records or array of MagesterEvent objects
     * @since 3.6.0
     * @access public
    */
    ...
    */
     ...
     * <br/>Example:
     * <code>
     * $events = MagesterEvent::getForumEvents('joe');
     * or
     * $events = MagesterEvent::getForumEvents(array('joe', 'averel', 'jack'), true, 10);	//10 MagesterEvent objects will be returned
     * </code>
     *
     * @param $login the login of the associated user or an array of all related users logins
     * @param $returnObjects whether to return MagesterEvent objects or arrays of data from the databaes
     ...
     * Trigger an event
     *
     * Denotes the triggering of an event in the SysClass system
     ...
     * $event = MagesterEvent::triggerEvent($fields);
     * </code>
     *
     * @param array $fields The new fields
     * @param boolean $send_notification Send notification or not
     * @return MagesterEvent the new event
     * @since 3.6.0
     * @access public
     */
    public static function triggerEvent($fields, $send_notification = true) {
        ...
        if ($fields['type'] == MagesterEvent::CONTENT_COMPLETION) {
            if (isset($fields['entity_ID']) && !isset($fields['entity_name'])) {
                $unit_info = new MagesterUnit($fields['entity_ID']);
                $fields['entity_name'] = $unit_info['name'];
            }
        }
        // If social SysClass module is enabled then log this event
    ...
    private function createSubstitutionsArray($event_types, $send_recipients) {
        ...
        if ($send_recipients == MagesterNotification::TRIGGERINGUSER) {
        ...
        $triggeringUser = MagesterUserFactory::factory($this->event['users_LOGIN']);
        ...
        if ($this->event['type'] == MagesterEvent::SYSTEM_NEW_PASSWORD_REQUEST) {
            ...
            if ($type['category'] == "courses") {
                ...
                if ($this->event['lessons_ID'] == 0) {
                    ...
                    if ($this->event['lessons_name']) {
                        ...
                        try {
                            $lesson = new MagesterLesson($this->event['lessons_ID']);
     ...
     * <code>
     * $fields = array('name' => 'new event', 'languages_NAME' => 'english');
     * $event = MagesterEvent::logEvent($fields);
     * </code>
     *
     * @param array $fields The new fields
     * @return MagesterEvent the new event
    ...
    */
    public function createMessage($modulesArray = false) {
        ...
        global $currentUser;
        // Module related code
        if ($this->event['type'] >= MagesterEvent::MODULE_BASE_TYPE_CODE) {
