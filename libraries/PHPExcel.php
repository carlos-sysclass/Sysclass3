...
class PHPExcel
{
	...
	function array2ExcelSimple( $data, $title )
	{
		...
		$this->getProperties()->setCreator("Sysclass")
							 ...
							 ->setTitle("Sysclass")
							 ->setSubject("Office 2007 XLSX Sysclass Document")
							 ->setDescription("Sysclass document for Office 2007 XLSX, generated using PHP classes.")
							 ->setKeywords("office 2007 openxml php")
							 ->setCategory("Sysclass result file");
