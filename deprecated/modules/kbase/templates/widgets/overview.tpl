...
<form id="kbase-widget-form" action="#">
   <div class="chat-form">
   ...
   <div class="panel panel-default <% if (model.approved == 0 && !has_answer) { %><% } else if (!has_answer) {  %><% } else { %><% } %>">
      <div class="panel-heading">
         <h4 class="panel-title">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#kbase-accordion" href="#kbase-accordion-panel-<%= model.id %>">
            <%= model.title %>
            <% if (model.approved == 0) { %>
      ...
      <div id="kbase-accordion-panel-<%= model.id %>" class="panel-collapse collapse">
