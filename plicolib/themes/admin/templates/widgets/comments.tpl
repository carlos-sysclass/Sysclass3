<div class="widget">
	...
	<div class="widget-body">
		<div class="media">
			<img alt="" src="theme/images/mrawesome.jpg" class="media-object pull-left">
			<div class="media-body">
				<blockquote>
					  ...
					  <small><a title="" href="#">John Doe</a><cite> | client @ Famous Company</cite></small>
				</blockquote>
			</div>
		</div>
		<div class="media">
			<img alt="" src="theme/images/mrawesome.jpg" class="media-object pull-right">
			<div class="media-body">
