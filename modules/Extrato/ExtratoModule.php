<?php
namespace Sysclass\Modules\Extrato;
/**
 * Module Class File
 * @filesource
 */
 ...
 */
/**
 * @RoutePrefix("/module/extrato")
 */
class ExtratoModule extends \SysclassModule implements \ILinkable, \IBreadcrumbable, \IActionable
{
    /* ILinkable */
   ...
   /* public function addItemAction($id)
    {
        if ($userData = $this->getCurrentUser()) {
            ...
            $itemModel = $this->model("courses/extratos/collection");
