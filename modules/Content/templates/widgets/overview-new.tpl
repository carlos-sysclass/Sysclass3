      ...
      <div class="row">
          ...
          <div class="col-md-12 no-padding inter-navsuper">
            <ul class="nav nav-tabs col-md-8 no-padding" role="tablist">
              <li role="presentation">
              	<a href="#unit" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-sitemap"></i>Unidades</a>
              </li>
              <li role="presentation">
              	<a href="#home" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-sitemap"></i>Cursos</a>
              </li>
              <li role="presentation">
              	<a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-sitemap"></i>Timeline</a>
              </li>
              <li role="presentation" class="active">
              	<a href="#program-tab" aria-controls="program-tab" role="tab" data-toggle="tab"><i class="fa fa-sitemap"></i>Programa</a>
              </li>
            </ul>
        ...
        <div class="col-sm-12 col-md-12 inter-navsuper-tabs">
          <div class="tab-content">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <!-- DATA DE ? -->
                    <span class="at-difinf">24/10/2014 às 20:30h</span></td>
                  ...
                  <tr>
                    <td><a href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-eye"></i></a></td>
                    <td>Compras Sustentáveis <span class="at-difinf">24/10/2014 às 20:30h</span></td>
                    <td>Carlos Oliveira <span class="at-difinf"><a href="">ver perfil</a></span></td>
                    <td>1/5 Avaliação do Ciclo de Vida</td>
                    <td class="nota-tal">N/A</td>
                    <td><button type="button" class="btn btn-primary">FAZER</button></td>
                  </tr>
                  <tr>
            ...
            <div role="tabpanel" class="tab-pane active" id="program-tab">
            	<div id="tab_program_description">
            	</div>
            </div>
          </div>
        </div>
