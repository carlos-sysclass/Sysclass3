				...
				<div class="tab-content">
					<div class="tab-pane active" id="yourinfo">
						...
						<div class="form-body">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{translateToken value="Program2"}</label>
									<input name="enrollment_program" readonly="readonly" value="{$T_EDIT_USER.course_interest}" type="text" placeholder="{translateToken value="Program"}" class="form-control" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
