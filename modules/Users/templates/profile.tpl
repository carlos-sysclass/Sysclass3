						...
						<div class="form-body">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input name="enrollment_program" readonly="readonly" value="{$T_EDIT_USER.attrs.attrs_course_interest}" type="text" placeholder="{translateToken value="Program"}" class="form-control" />
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
