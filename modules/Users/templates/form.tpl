			...
			<div class="tab-pane fade active in" id="tab_1_1">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input name="id" value="" readonly="readonly" type="text" placeholder="{translateToken value="Student ID"}" class="form-control" />
						</div>
					</div>
				</div>
				<div class="row">
					<!-- div class="col-md-6">
						<div class="form-group">
							...
							<input name="enrollments" readonly="readonly" value="" type="text" placeholder="{translateToken value="Enrollment date"}" class="form-control" data-rule-required="true" data-rule-minlength="3" />
						</div>
					</div-->
				...
				{if $isTeacher}
					<h5 class="form-section margin-bottom-100">
						...
						{translateToken value="User info"}
					</h5>
