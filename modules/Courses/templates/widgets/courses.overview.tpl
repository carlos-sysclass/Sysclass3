				...
				<div id="lesson-tab" class="tab-pane active">
					...
					<div class="tabbable-custom ">
						<ul class="nav nav-tabs ">
							...
							<li class="">
								<a data-toggle="tab" href="#tab_lesson_materials"><i class="fa fa-file-archive-o"></i> <span class="hidden-xs inline active-show-xs">{translateToken value="Materials"}</span></a>
							</li>
							<li class="">
