<div id="roadmap-grouping-dialog-modal" class="modal fade" tabindex="-1">
    <form role="form" class="form-horizontal form-validate" method="post" action="" data-validate="true">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{translateToken value="Add a new Course Grouping"}</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <input name="name" value="" type="text" placeholder="Start Date" class="form-control date-picker" data-rule-required="true" />
                </div>
                <div class="form-group">
                    <label class="control-label">{translateToken value="Grouping End Date"}</label>
                    <input name="name" value="" type="text" placeholder="End Date" class="form-control date-picker"/>
                </div>
