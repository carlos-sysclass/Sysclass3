<div class="social-gadgets btn-group-vertical hidden-xs hidden-sm">
	...
	<!--
	<a class="btn btn-lg btn-danger tooltips" href="#" data-original-title="{translateToken value="Google Plus"}" data-placement="left">
		<i class="icon-google-plus"></i>
	</a>
	-->
	<a class="btn btn-lg btn-danger" id="open-pageguide-action" href="#">
		<i class="fa fa-question-circle tooltips"  data-original-title="{translateToken value="Need help"}" data-placement="left"></i>
	</a>
</div>
