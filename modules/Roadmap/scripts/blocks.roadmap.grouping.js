$SC.module("blocks.roadmap.grouping", function(mod, app, Backbone, Marionette, $, _) {
    // MODELS
    ...
    mod.on("start", function(opt){
        ...
        */
        mod.groupingModelClass = Backbone.Model.extend({
            defaults : {
                name: "",
                start_date : "",
                end_date : ""
        ...
        mod.groupingCollectionClass = Backbone.Collection.extend({
        ...
        mod.groupingAddDialogClass = baseFormClass.extend({
            initialize : function(opt) {
        ...
        mod.roadmapBlockItemViewClass = Backbone.View.extend({
            events : {
        ...
        mod.roadmapBlockViewClass = Backbone.View.extend({
            ...
            addItem : function(e) {
                ...
                this.listenTo(roadmapBlockClassItemView, "unit:updated", function(model) {
                    self.refreshCounters();
                });
        ...
        $("[data-widget-id='roadmap-grouping-widget']").each(function() {
            var course_id = null;
    ...
    mod.createBlock = function(el, data) {
        ...
        mod.collectionTest = groupingCollection;
    };
