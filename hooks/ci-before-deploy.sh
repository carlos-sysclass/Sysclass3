...
MESSAGE="${bamboo.planName} build number ${bamboo.buildNumber} passed automated acceptance testing." ${bamboo.planRepository.revision}

$git_bin add $bamboo_working_directory/RELEASE

$git_bin tag -a ${FULL_RELEASE} -m "${bamboo.planName} build number ${bamboo.buildNumber} passed automated acceptance testing." ${bamboo.planRepository.revision}
